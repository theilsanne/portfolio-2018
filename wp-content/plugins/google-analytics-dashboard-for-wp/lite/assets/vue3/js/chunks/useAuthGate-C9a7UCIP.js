import { ak as NOOP, al as extend$1, am as isString, an as NO, ao as isSymbol, ap as isBuiltInDirective, aq as capitalize, ar as camelize, as as EMPTY_OBJ, at as isObject, au as toHandlerKey, av as isArray, aw as isOn, ax as isReservedProp, ay as isVoidTag, az as isHTMLTag, aA as isSVGTag, aB as isMathMLTag, aC as parseStringStyle, aD as makeMap, aE as generateCodeFrame, aF as getAugmentedNamespace, aG as runtimeDom_esmBundler, aH as shared_esmBundler, aI as getDefaultExportFromCjs, ag as useRouter, w as watch, p as onMounted, j as onUnmounted, o as openBlock, c as createElementBlock, a as createBaseVNode, b as createVNode, v as createBlock, C as withCtx, D as normalizeStyle, W as toDisplayString, u as unref, $ as __, z as createCommentVNode, T as Transition, K as Teleport, l as ref, t as nextTick, M as computed, O as reactive, x as withDirectives, Z as vModelText, J as withKeys, E as normalizeClass, aa as getMiGlobal, a0 as defineStore, ah as getWidgetSupportForType, a8 as _export_sfc, y as vShow, V as Fragment, R as renderList, X as createTextVNode, I as withModifiers, F as renderSlot, A as mergeProps, U as resolveDynamicComponent, a6 as sprintf, a1 as getMiGlobal$1 } from "./TheAppHeader-CnbU8fIT.js";
import { u as useFeatureGate, I as Icon } from "./useFeatureGate-Dycj7kF_.js";
import { L as LoadingSpinnerInline, u as useChartColors, m, b as brandConfig } from "./ReAuthModal-Deg5HLL-.js";
import { a as html2pdf } from "./html2pdf-DUUmuX6G.js";
...
const _hoisted_1$d = { class: "exactmetrics-dashboard-tabs" };
...
const _hoisted_1$c = { class: "exactmetrics-widget__header" };
const _hoisted_2$b = {
  key: 0,
...
const _hoisted_7$2 = { class: "exactmetrics-widget__checkbox-text" };
const _hoisted_8$2 = { class: "exactmetrics-widget__body" };
const _hoisted_9$2 = {
  key: 0,
          ...
          __props.isEditable ? (openBlock(), createElementBlock("div", _hoisted_3$5, [
            ...
            showMenu.value ? withDirectives((openBlock(), createElementBlock("div", _hoisted_5$3, [
              ...
              supportsComparison.value ? (openBlock(), createElementBlock("label", {
                ...
                createBaseVNode("span", _hoisted_7$2, toDisplayString(unref(__)("Show Comparison", "google-analytics-dashboard-for-wp")), 1)
              ])) : createCommentVNode("", true),
              createBaseVNode("button", {
...
const _hoisted_1$b = { class: "exactmetrics-key-metric__period-block" };
const _hoisted_2$a = { class: "exactmetrics-key-metric__value-row" };
const _hoisted_3$4 = { class: "exactmetrics-key-metric__value" };
const _hoisted_4$2 = { class: "exactmetrics-key-metric__date-range" };
const _hoisted_5$2 = { class: "exactmetrics-key-metric__period-block exactmetrics-key-metric__period-block--previous" };
const _hoisted_6$1 = { class: "exactmetrics-key-metric__value" };
const _hoisted_7$1 = { class: "exactmetrics-key-metric__date-range" };
const _hoisted_8$1 = { class: "exactmetrics-key-metric__value" };
const _hoisted_9$1 = {
  key: 0,
  class: "exactmetrics-key-metric__comparison"
};
const _hoisted_10$1 = { class: "exactmetrics-key-metric__period" };
const _sfc_main$f = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const comparisonPeriod = computed(() => {
      ...
      if (props.data?.dateRange?.current?.start && props.data?.dateRange?.current?.end) {
        ...
        return __("vs. Previous %s Days", "google-analytics-dashboard-for-wp").replace("%s", days);
      }
...
const _hoisted_1$a = { class: "exactmetrics-apex-chart" };
const _hoisted_2$9 = {
  key: 1,
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$a, [
        hasData.value ? (openBlock(), createBlock(unref(apexchart), {
          ...
          series: series.value
        }, null, 8, ["height", "options", "series"])) : (openBlock(), createElementBlock("div", _hoisted_2$9, toDisplayString(unref(__)("No data available", "google-analytics-dashboard-for-wp")), 1))
      ]);
    };
  }
};
...
const _sfc_main$d = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const errorMessage = computed(() => {
      if (props.data?.error) {
        return props.data.message || __("Error loading chart data", "google-analytics-dashboard-for-wp");
      }
      return null;
    });
...
const _hoisted_1$9 = { class: "exactmetrics-apex-chart" };
const _hoisted_2$8 = {
  key: 1,
  class: "exactmetrics-apex-chart__empty"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$9, [
        hasData.value ? (openBlock(), createBlock(unref(apexchart), {
          ...
          options: chartOptions.value,
          series: series.value
        }, null, 8, ["height", "options", "series"])) : (openBlock(), createElementBlock("div", _hoisted_2$8, toDisplayString(unref(__)("No data available", "google-analytics-dashboard-for-wp")), 1))
      ]);
    };
  }
};
...
const _hoisted_1$8 = { class: "exactmetrics-apex-chart" };
const _hoisted_2$7 = {
  key: 1,
  class: "exactmetrics-apex-chart__empty"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$8, [
        hasData.value ? (openBlock(), createBlock(unref(apexchart), {
          ...
          options: chartOptions.value,
          series: series.value
        }, null, 8, ["height", "options", "series"])) : (openBlock(), createElementBlock("div", _hoisted_2$7, toDisplayString(unref(__)("No data available", "google-analytics-dashboard-for-wp")), 1))
      ]);
    };
  }
};
...
const _hoisted_1$7 = { class: "exactmetrics-apex-chart" };
const _hoisted_2$6 = {
  key: 1,
  class: "exactmetrics-apex-chart__empty"
};
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        hasData.value ? (openBlock(), createBlock(unref(apexchart), {
          ...
          options: chartOptions.value,
          series: series.value
        }, null, 8, ["height", "options", "series"])) : (openBlock(), createElementBlock("div", _hoisted_2$6, toDisplayString(unref(__)("No data available", "google-analytics-dashboard-for-wp")), 1))
      ]);
    };
  }
};
...
const _hoisted_1$6 = {
  key: 0,
  class: "exactmetrics-data-table"
};
const _hoisted_2$5 = { class: "exactmetrics-data-table__wrapper" };
const _hoisted_3$3 = { class: "exactmetrics-data-table__table" };
const _hoisted_4$1 = ["colspan", "onClick"];
const _hoisted_5$1 = {
  key: 0,
  class: "exactmetrics-data-table__sort-icon"
};
const _hoisted_6 = {
  key: 0,
  class: "exactmetrics-data-table__subheader-row"
};
const _hoisted_7 = {
  key: 0,
  class: "exactmetrics-data-table__subheader exactmetrics-data-table__subheader--empty"
};
...
const _hoisted_12 = {
  key: 0,
  class: "exactmetrics-data-table__footer"
};
const _hoisted_13 = { key: 1 };
const _hoisted_14 = {
  key: 2,
  class: "exactmetrics-data-table__pagination"
};
const _hoisted_15 = { class: "exactmetrics-data-table__pagination-label" };
const _hoisted_16 = ["onClick"];
const _hoisted_17 = {
  key: 1,
  class: "exactmetrics-data-table__empty"
};
const _sfc_main$6 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    function formatDimensionLabel(dimension) {
      const labelMap = {
        ...
        "sessionCampaignName": __("Campaign", "google-analytics-dashboard-for-wp"),
        "landingPage": __("Landing Page", "google-analytics-dashboard-for-wp"),
        "sessionDefaultChannelGrouping": __("Channel", "google-analytics-dashboard-for-wp"),
        "country": __("Country", "google-analytics-dashboard-for-wp"),
        "deviceCategory": __("Device", "google-analytics-dashboard-for-wp"),
    ...
    function formatMetricLabel(metric) {
      const labelMap = {
        "sessions": __("Sessions", "google-analytics-dashboard-for-wp"),
        "screenPageViews": __("Page Views", "google-analytics-dashboard-for-wp"),
        "engagedSessions": __("Engaged Sessions", "google-analytics-dashboard-for-wp"),
        "activeUsers": __("Active Users", "google-analytics-dashboard-for-wp"),
        "keyEvents": __("Key Events", "google-analytics-dashboard-for-wp"),
        "eventCount": __("Event Count", "google-analytics-dashboard-for-wp"),
        "engagementRate": __("Engagement Rate", "google-analytics-dashboard-for-wp")
      };
      return labelMap[metric] || metric;
    }
    const errorMessage = computed(() => {
      if (props.data?.error) {
        return props.data.message || __("Error loading table data", "google-analytics-dashboard-for-wp");
      }
      return null;
    });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$g, {
        ...
        default: withCtx(() => [
          hasData.value ? (openBlock(), createElementBlock("div", _hoisted_1$6, [
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (column, index2) => {
                      return openBlock(), createElementBlock("th", {
                        ...
                        class: normalizeClass([
                          "exactmetrics-data-table__header",
                          { "exactmetrics-data-table__header--sortable": column.sortable !== false },
                          { "exactmetrics-data-table__header--has-subheaders": hasComparison.value && column.isMetric }
                        ]),
                    ...
                    (openBlock(true), createElementBlock(Fragment, null, renderList(columns.value, (column, index2) => {
                      return openBlock(), createElementBlock(Fragment, { key: index2 }, [
                        !column.isMetric ? (openBlock(), createElementBlock("th", _hoisted_7)) : (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                          createBaseVNode("th", {
                            class: "exactmetrics-data-table__subheader exactmetrics-data-table__subheader--sortable",
                            onClick: ($event) => sortBy(index2 * 2 + dimensionCount.value)
                          }, [
                            createTextVNode(toDisplayString(unref(__)("Current", "google-analytics-dashboard-for-wp")) + " ", 1),
                          ...
                          createBaseVNode("th", {
                            ...
                            createTextVNode(toDisplayString(unref(__)("Previous", "google-analytics-dashboard-for-wp")) + " ", 1),
            ...
            totalRows.value > perPage.value || hasGaLink.value ? (openBlock(), createElementBlock("div", _hoisted_12, [
              hasGaLink.value ? (openBlock(), createElementBlock("button", {
                key: 0,
                class: "exactmetrics-button exactmetrics-button-view-full-report",
                onClick: loadMore
              }, toDisplayString(unref(__)("View Full Report", "google-analytics-dashboard-for-wp")), 1)) : (openBlock(), createElementBlock("span", _hoisted_13)),
              totalRows.value > perPage.value ? (openBlock(), createElementBlock("div", _hoisted_14, [
                createBaseVNode("span", _hoisted_15, toDisplayString(unref(__)("Show", "google-analytics-dashboard-for-wp")), 1),
                (openBlock(true), createElementBlock(Fragment, null, renderList(__props.perPageOptions, (option2) => {
                  return openBlock(), createElementBlock("button", {
                    key: option2,
                    class: normalizeClass([
                      "exactmetrics-data-table__pagination-option",
                      { "exactmetrics-data-table__pagination-option--active": perPage.value === option2 }
                    ]),
          ...
          ])) : (openBlock(), createElementBlock("div", _hoisted_17, toDisplayString(unref(__)("No data available", "google-analytics-dashboard-for-wp")), 1))
        ]),
        _: 1
...
const _hoisted_1$5 = {
  key: 0,
  class: "exactmetrics-widget-footer-link"
};
        ...
        footer: withCtx(() => [
          widgetMetadata.value?.reportUrl ? (openBlock(), createElementBlock("div", _hoisted_1$5, [
            createBaseVNode("a", {
              ...
              createTextVNode(toDisplayString(_ctx.__("View full report", "google-analytics-dashboard-for-wp")) + " ", 1),
              createVNode(Icon, {
                name: "external-link",
                size: 12
              })
...
const _hoisted_2$3 = { class: "exactmetrics-widget-resize-preview__label" };
const _sfc_main$4 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["exactmetrics-widget-display", [
          `exactmetrics-widget-display--width-${widgetWidth.value}`,
          `exactmetrics-widget-display--height-${widgetHeight.value}`,
          { "exactmetrics-widget-display--resizing": isResizing.value }
        ]]),
        ...
        __props.isResizable ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "exactmetrics-widget-resize-handle",
          onMousedown: withModifiers(startResize, ["stop"]),
          onTouchstart: withModifiers(startResize, ["stop"])
        }, [..._cache[0] || (_cache[0] = [
          createBaseVNode("div", { class: "exactmetrics-widget-resize-handle__icon" }, null, -1)
        ])], 32)) : createCommentVNode("", true),
        isResizing.value && previewWidth.value !== widgetWidth.value ? (openBlock(), createElementBlock("div", {
          key: 1,
          class: normalizeClass(["exactmetrics-widget-resize-preview", `exactmetrics-widget-resize-preview--width-${previewWidth.value}`])
        }, [
          createBaseVNode("div", _hoisted_2$3, toDisplayString(previewWidth.value) + " " + toDisplayString(previewWidth.value === 1 ? unref(__)("column", "google-analytics-dashboard-for-wp") : unref(__)("columns", "google-analytics-dashboard-for-wp")), 1)
        ], 2)) : createCommentVNode("", true)
      ], 42, _hoisted_1$4);
    };
  }
...
const _hoisted_1$3 = {
  key: 0,
  class: "exactmetrics-empty-state"
};
const _hoisted_2$2 = { class: "exactmetrics-empty-state__content" };
const _hoisted_3$2 = { class: "exactmetrics-empty-state__illustration" };
const _sfc_main$3 = {
  __name: "WidgetsGrid",
  props: {
    widgets: {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(draggable), {
        ...
        "item-key": "id",
        class: normalizeClass(["exactmetrics-widget-grid", {
          "exactmetrics-widget-grid--disabled": !__props.isDraggable && __props.isEditable,
          "exactmetrics-widget-grid--edit-mode": __props.isEditable
        }]),
        ...
        footer: withCtx(() => [
          !hasWidgets.value ? (openBlock(), createElementBlock("div", _hoisted_1$3, [
            createBaseVNode("div", _hoisted_2$2, [
              createBaseVNode("h2", null, toDisplayString(unref(__)("Your Custom View is Empty", "google-analytics-dashboard-for-wp")), 1),
              createBaseVNode("p", null, toDisplayString(unref(__)("Start building your dashboard by dragging widgets here", "google-analytics-dashboard-for-wp")), 1)
            ]),
...
const _sfc_main$2 = {
  ...
  props: {
    reportTitle: {
      type: String,
      default: __("Custom Report", "google-analytics-dashboard-for-wp")
    },
    buttonText: {
      type: String,
      default: __("Export PDF Report", "google-analytics-dashboard-for-wp")
    },
    reportContainer: {
      type: String,
      default: ".exactmetrics-dashboard-main"
      // Target the main dashboard content
    },
    filename: {
      type: String,
      default: "exactmetrics-custom-report.pdf"
    },
    disabled: {
      type: Boolean,
      default: false
  ...
  setup(__props) {
    ...
    function exportPDFReport() {
      ...
      if (!report) {
        alert(__("Error: Report container not found.", "google-analytics-dashboard-for-wp"));
        return;
      }
    ...
    async function doExport(report) {
      ...
      const opt = {
        ...
        html2canvas: {
          ...
          onclone: (_clonedDoc, clonedElement) => {
            ...
            const widgets = clonedElement.querySelectorAll(".exactmetrics-widget, .exactmetrics-widget-display");
      ...
      try {
        ...
        for (let i = 1; i <= totalPages; i++) {
          ...
          pdf.setFontSize(8);
          pdf.text(
            sprintf(__("Page %1$d of %2$d", "google-analytics-dashboard-for-wp"), i, totalPages),
            pageWidth / 2,
            pageHeight - 10,
            { align: "center" }
          );
        ...
        alert(__("Failed to generate PDF. See console for details.", "google-analytics-dashboard-for-wp"));
      } finally {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("button", {
        class: normalizeClass(["exactmetrics-button exactmetrics-button--secondary exactmetrics-export-pdf-button", { "exactmetrics-button--disabled": __props.disabled }]),
...
const _hoisted_1$1 = {
  key: 0,
  class: "exactmetrics-sample-data-notice"
};
const _hoisted_2$1 = { class: "exactmetrics-sample-data-notice__content" };
const _hoisted_3$1 = { class: "exactmetrics-sample-data-notice__text" };
const _hoisted_4 = { class: "exactmetrics-sample-data-notice__actions" };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const noticeText = computed(() => {
      return sprintf(
        __("You're viewing sample data. Upgrade to %s to unlock real analytics and save your custom dashboards.", "google-analytics-dashboard-for-wp"),
        minimumLicense.value
      );
    });
    const upgradeButtonText = computed(() => {
      return sprintf(
        __("Upgrade to %s", "google-analytics-dashboard-for-wp"),
        minimumLicense.value
      );
    });
    function dismiss() {
    ...
    return (_ctx, _cache) => {
      return !isDismissed.value ? (openBlock(), createElementBlock("div", _hoisted_1$1, [
        ...
        createBaseVNode("div", _hoisted_4, [
          createBaseVNode("button", {
            class: "exactmetrics-sample-data-notice__upgrade-btn",
          ...
          __props.dismissable ? (openBlock(), createElementBlock("button", {
            key: 0,
            class: "exactmetrics-sample-data-notice__close-btn",
            onClick: dismiss,
            "aria-label": unref(__)("Dismiss", "google-analytics-dashboard-for-wp")
          }, [
            createVNode(Icon, {
...
const _hoisted_1 = { class: "exactmetrics-error-modal" };
const _hoisted_2 = ["aria-label"];
const _hoisted_3 = { class: "exactmetrics-error-actions" };
const _sfc_main = {
  __name: "ErrorModal",
  props: {
    isOpen: {
        ...
        createVNode(Transition, { name: "error-fade" }, {
          default: withCtx(() => [
            __props.isOpen ? (openBlock(), createElementBlock("div", {
              key: 0,
              class: "exactmetrics-error-overlay",
              ...
              createBaseVNode("div", _hoisted_1, [
                __props.dismissible ? (openBlock(), createElementBlock("button", {
                  key: 0,
                  type: "button",
                  class: "exactmetrics-error-close",
                  onClick: handleClose,
                ...
                _cache[1] || (_cache[1] = createBaseVNode("div", { class: "exactmetrics-error-icon" }, [
                  createBaseVNode("svg", {
                    width: "40",
                    height: "40",
                    viewBox: "0 0 40 40",
                ...
                createBaseVNode("div", _hoisted_3, [
                  __props.showRetry ? (openBlock(), createElementBlock("button", {
                    key: 0,
                    type: "button",
                    class: "exactmetrics-button-primary exactmetrics-error-button",
                    onClick: handleRetry
                  }, toDisplayString(unref(__)("Try Again", "google-analytics-dashboard-for-wp")), 1)) : createCommentVNode("", true),
                  __props.dismissible ? (openBlock(), createElementBlock("button", {
                    key: 1,
                    type: "button",
                    class: "exactmetrics-button-secondary exactmetrics-error-button",
                    onClick: handleClose
                  }, toDisplayString(unref(__)("Dismiss", "google-analytics-dashboard-for-wp")), 1)) : createCommentVNode("", true)
                ])
              ])
            ])) : createCommentVNode("", true)
          ]),
