import { a8 as _export_sfc, o as openBlock, c as createElementBlock, a as createBaseVNode, W as toDisplayString, z as createCommentVNode, F as renderSlot, V as Fragment, $ as __$1, m as defineComponent, aJ as h, aR as onBeforeMount, p as onMounted, k as getCurrentInstance, q as onBeforeUnmount, w as watch, l as ref, t as nextTick, aS as toRefs, a1 as getMiGlobal, v as createBlock, C as withCtx, T as Transition, u as unref, aM as getUrl } from "./TheAppHeader-CnbU8fIT.js";
...
const _sfc_main$2 = {
  ...
  props: {
    label: { type: String, default: __$1("Loading", "google-analytics-dashboard-for-wp") },
...
const _hoisted_2$1 = { class: "exactmetrics-settings-input exactmetrics-settings-input-authenticate" };
const _hoisted_3 = { class: "exactmetrics-dark" };
const _hoisted_4 = { key: 0 };
const _hoisted_5 = ["disabled"];
const _hoisted_6 = { class: "exactmetrics-disclaimer-note" };
const _hoisted_7 = { key: 1 };
const _hoisted_8 = { class: "exactmetrics-dark" };
const _sfc_main$1 = {
  __name: "AuthModal",
  props: {
    isOpen: {
  ...
  setup(__props) {
    ...
    const text_no_auth = __$1("You must connect with ExactMetrics before you can view reports.", "google-analytics-dashboard-for-wp");
    const text_auth_label = __$1("ExactMetrics makes it effortless for you to connect your site with Google Analytics and see reports right here in the WordPress dashboard.", "google-analytics-dashboard-for-wp");
    const text_wizard = __$1("Launch Setup Wizard", "google-analytics-dashboard-for-wp");
    const text_ask_webmaster = __$1("Please ask your webmaster to connect ExactMetrics to Google Analytics.", "google-analytics-dashboard-for-wp");
    const text_onboarding_note = sprintf2(__$1("Note: You will be transfered to %1$s.com to complete the setup wizard.", "google-analytics-dashboard-for-wp"), productName);
    function launchSetupWizard() {
      isLoading.value = true;
      const action = "exactmetrics_generate_setup_wizard_url";
      const ajaxData = {
            ...
            createBaseVNode("div", _hoisted_2$1, [
              ...
              unref(canUpdateSettings) ? (openBlock(), createElementBlock("div", _hoisted_4, [
                createBaseVNode("button", {
                  type: "button",
                  class: "exactmetrics-button-alt exactmetrics-button",
...
const fetchAuth = () => new Promise((resolve, reject) => {
  const action = "exactmetrics_vue_get_profile";
  const ajaxData = {
    nonce: getMiGlobal("nonce")
  };
  wp.ajax.post(action, ajaxData).done((response) => {
    ...
    const message = errorThrown || __("An error occurred.", "google-analytics-dashboard-for-wp");
    let title = __(
...
const getAuthRedirect = (network = false) => {
  return new Promise((resolve, reject) => {
    const action = "exactmetrics_maybe_authenticate";
    const ajaxData = {
      nonce: getMiGlobal("nonce")
    };
    if (network) {
...
const getReAuthRedirect = (network = false) => {
  return new Promise((resolve, reject) => {
    const action = "exactmetrics_maybe_reauthenticate";
    const ajaxData = {
      nonce: getMiGlobal("nonce")
    };
    if (network) {
...
const verifyAuth = (network = false) => {
  return new Promise((resolve, reject) => {
    const action = "exactmetrics_maybe_verify";
    const ajaxData = {
      nonce: getMiGlobal("nonce"),
      isnetwork: network
    ...
    wp.ajax.post(action, ajaxData).done((response) => {
      ...
      const message = errorThrown || __("An error occurred.", "google-analytics-dashboard-for-wp");
      let title = __("Error verifying auth", "google-analytics-dashboard-for-wp");
      if (jqXHR?.status) {
        title = sprintf(
          __(
...
const deleteAuth = (network = false, force = false) => {
  return new Promise((resolve, reject) => {
    const action = "exactmetrics_maybe_delete";
    const ajaxData = {
      nonce: getMiGlobal("nonce"),
      isnetwork: network
    };
...
const updateManualV4 = (v4 = "", network = false) => {
  return new Promise((resolve, reject) => {
    const action = "exactmetrics_update_manual_v4";
    const ajaxData = {
      manual_v4_code: v4,
      nonce: getMiGlobal("nonce")
    };
...
const updateMeasurementProtocolSecret = (value = "", network = false) => {
  return new Promise((resolve, reject) => {
    const action = "exactmetrics_update_measurement_protocol_secret";
    const ajaxData = {
      value,
      nonce: getMiGlobal("nonce")
    };
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const text_no_auth = __$1("ExactMetrics encountered an error loading your report data", "google-analytics-dashboard-for-wp");
    const text_auth_label = __$1("There is an issue with your Google Account authentication. Please use the button below to fix it by re-authenticating.", "google-analytics-dashboard-for-wp");
    const text_button_reconnect = __$1("Reconnect ExactMetrics", "google-analytics-dashboard-for-wp");
