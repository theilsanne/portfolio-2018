    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$b, [
        hasData.value ? (openBlock(), createBlock(unref(apexchart), {
          ...
          series: series.value
        }, null, 8, ["type", "height", "options", "series"])) : (openBlock(), createElementBlock("div", _hoisted_2$b, toDisplayString(unref(__$1)("No data available", "google-analytics-dashboard-for-wp")), 1))
      ]);
    };
  }
};
...
const _hoisted_1$a = { class: "exactmetrics-overview-notes" };
const _hoisted_2$a = { class: "exactmetrics-overview-notes__header" };
const _hoisted_3$a = { class: "exactmetrics-overview-notes__header-left" };
const _hoisted_4$8 = { class: "exactmetrics-overview-notes__header-left-links" };
const _hoisted_5$8 = { class: "text" };
const _hoisted_6$8 = { class: "text" };
const _hoisted_7$8 = { class: "exactmetrics-overview-notes__header-right" };
const _hoisted_8$8 = { class: "exactmetrics-overview-notes__body" };
const _hoisted_9$7 = { class: "exactmetrics-overview-notes__body-list" };
const _hoisted_10$6 = {
  key: 0,
  class: "exactmetrics-overview-notes__loading"
};
const _hoisted_11$6 = {
  key: 1,
  class: "exactmetrics-overview-notes__table"
};
const _hoisted_12$6 = { class: "exactmetrics-overview-notes__col-date" };
const _hoisted_13$5 = { class: "exactmetrics-overview-notes__col-date" };
const _hoisted_14$4 = { class: "exactmetrics-overview-notes__date-cell" };
const _hoisted_15$4 = ["onClick"];
const _hoisted_16$4 = {
  key: 0,
  class: "exactmetrics-star-spinner"
};
const _hoisted_17$4 = {
  key: 1,
  class: "star-icon",
...
const _hoisted_19$4 = { class: "exactmetrics-overview-notes__col-note" };
const _hoisted_20$4 = { class: "exactmetrics-overview-notes__note-cell" };
const _hoisted_21$3 = ["onClick"];
const _hoisted_22$3 = { class: "exactmetrics-overview-notes__col-category" };
const _hoisted_23$2 = {
  key: 1,
  class: "exactmetrics-category-badge exactmetrics-category-badge--default"
};
const _hoisted_24$2 = {
  key: 0,
  class: "exactmetrics-overview-notes__edit-row"
};
const _hoisted_25$1 = { class: "exactmetrics-overview-notes__col-date" };
const _hoisted_26$1 = { class: "exactmetrics-overview-notes__edit-date-cell" };
const _hoisted_27$1 = {
  key: 0,
  class: "star-icon",
  width: "18",
...
const _hoisted_29$1 = { class: "exactmetrics-overview-notes__col-note" };
const _hoisted_30$1 = { class: "exactmetrics-overview-notes__edit-note-cell" };
const _hoisted_31$1 = ["disabled"];
const _hoisted_32$1 = { class: "exactmetrics-overview-notes__edit-actions" };
const _hoisted_33$1 = ["disabled"];
const _hoisted_34$1 = { class: "exactmetrics-overview-notes__col-category" };
const _hoisted_35$1 = { class: "exactmetrics-site-note-select" };
...
const _hoisted_41$1 = { class: "exactmetrics-overview-notes__empty" };
const _hoisted_42$1 = {
  key: 1,
  class: "exactmetrics-overview-notes__create"
};
const _hoisted_43$1 = { class: "exactmetrics-overview-notes__create-header" };
const _hoisted_44$1 = { class: "exactmetrics-overview-notes__create-title" };
const _hoisted_45$1 = { class: "exactmetrics-overview-notes__create-form" };
const _hoisted_46$1 = { class: "exactmetrics-overview-notes__create-row" };
const _hoisted_47 = {
  key: 0,
  class: "star-icon",
  width: "24",
...
const _hoisted_49 = { class: "exactmetrics-overview-notes__create-field exactmetrics-overview-notes__create-field--date" };
const _hoisted_50 = { class: "exactmetrics-overview-notes__create-field exactmetrics-overview-notes__create-field--name" };
const _hoisted_51 = ["placeholder", "disabled"];
const _hoisted_52 = {
  key: 0,
  class: "exactmetrics-overview-notes__create-error"
};
const _hoisted_53 = { class: "exactmetrics-overview-notes__create-field exactmetrics-overview-notes__create-field--category" };
const _hoisted_54 = { class: "exactmetrics-site-note-select" };
const _hoisted_55 = ["disabled"];
const _hoisted_56 = { value: "0" };
const _hoisted_57 = ["value"];
const _hoisted_58 = { class: "exactmetrics-overview-notes__create-buttons" };
  ...
  setup(__props, { emit: __emit }) {
    ...
    async function createNote() {
      ...
      try {
        ...
        createError.value = error?.title || error?.message || __$1("An error occurred.", "google-analytics-dashboard-for-wp");
      } finally {
        isSaving.value = false;
      }
    }
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$a, [
        showList.value ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
          createBaseVNode("div", _hoisted_2$a, [
            createBaseVNode("div", _hoisted_3$a, [
              createBaseVNode("div", _hoisted_4$8, [
                createBaseVNode("span", null, toDisplayString(unref(__$1)("Show:", "google-analytics-dashboard-for-wp")), 1),
                createBaseVNode("a", {
                  href: "#",
                  class: normalizeClass({ selected: unref(siteNotesStore).importantFilter === null }),
                  onClick: withModifiers(removeFilters, ["prevent"])
                }, [
                  createBaseVNode("span", _hoisted_5$8, toDisplayString(unref(__$1)("All", "google-analytics-dashboard-for-wp")), 1),
                ...
                createBaseVNode("a", {
                  ...
                  createBaseVNode("span", _hoisted_6$8, toDisplayString(unref(__$1)("Important", "google-analytics-dashboard-for-wp")), 1),
            ...
            createBaseVNode("div", _hoisted_7$8, [
              createBaseVNode("button", {
                ...
                createBaseVNode("span", null, toDisplayString(unref(__$1)("Add New Site Note", "google-analytics-dashboard-for-wp")), 1)
              ])
            ])
          ]),
              ...
              !unref(siteNotesStore).loading ? (openBlock(), createElementBlock("table", _hoisted_11$6, [
                createBaseVNode("thead", null, [
                  createBaseVNode("tr", null, [
                    createBaseVNode("th", _hoisted_12$6, toDisplayString(unref(__$1)("Date", "google-analytics-dashboard-for-wp")), 1),
                    createBaseVNode("th", null, toDisplayString(unref(__$1)("Site Note", "google-analytics-dashboard-for-wp")), 1),
                    createBaseVNode("th", null, toDisplayString(unref(__$1)("Category", "google-analytics-dashboard-for-wp")), 1)
                  ])
                ]),
                createBaseVNode("tbody", null, [
                      ...
                      createBaseVNode("tr", null, [
                        createBaseVNode("td", _hoisted_13$5, [
                          createBaseVNode("div", _hoisted_14$4, [
                            createBaseVNode("a", {
                              href: "#",
                              class: "exactmetrics-toggle-note-important",
                        ...
                        createBaseVNode("td", _hoisted_25$1, [
                          createBaseVNode("div", _hoisted_26$1, [
                            ...
                            createVNode(unref(Component), {
                              ...
                              class: "exactmetrics-site-note-datepicker",
                        ...
                        createBaseVNode("td", _hoisted_29$1, [
                          createBaseVNode("div", _hoisted_30$1, [
                            withDirectives(createBaseVNode("textarea", {
                              ...
                              disabled: isSaving.value,
                              rows: "1",
                              class: "exactmetrics-site-note-textarea"
                          ...
                          createBaseVNode("div", _hoisted_32$1, [
                            ...
                            }, toDisplayString(unref(__$1)("Save Changes", "google-analytics-dashboard-for-wp")), 9, _hoisted_33$1),
                            createBaseVNode("a", {
                              href: "#",
                              class: "exactmetrics-button-secondary",
                              onClick: withModifiers(cancelEdit, ["prevent"])
                            }, toDisplayString(unref(__$1)("Cancel", "google-analytics-dashboard-for-wp")), 1)
                          ])
                        ]),
                        createBaseVNode("td", _hoisted_34$1, [
                          createBaseVNode("div", _hoisted_35$1, [
                            withDirectives(createBaseVNode("select", {
                              ...
                              createBaseVNode("option", _hoisted_37$1, toDisplayString(unref(__$1)("Select Category", "google-analytics-dashboard-for-wp")), 1),
                  ...
                  unref(siteNotesStore).filteredNotes.length === 0 && !unref(siteNotesStore).loading ? (openBlock(), createElementBlock("tr", _hoisted_39$1, [
                    createBaseVNode("td", _hoisted_40$1, [
                      createBaseVNode("div", _hoisted_41$1, toDisplayString(unref(__$1)("There aren't any site notes. Go ahead and create one!", "google-analytics-dashboard-for-wp")), 1)
                    ])
                  ])) : createCommentVNode("", true)
                ])
              ])) : createCommentVNode("", true)
          ...
          createBaseVNode("div", _hoisted_43$1, [
            createBaseVNode("span", _hoisted_44$1, toDisplayString(unref(__$1)("Site Notes", "google-analytics-dashboard-for-wp")), 1)
          ]),
          createBaseVNode("div", _hoisted_45$1, [
            createBaseVNode("div", _hoisted_46$1, [
              createBaseVNode("a", {
                href: "#",
                class: "exactmetrics-overview-notes__create-star",
              ...
              createBaseVNode("div", _hoisted_49, [
                createBaseVNode("label", null, toDisplayString(unref(__$1)("Date", "google-analytics-dashboard-for-wp")), 1),
                createVNode(unref(Component), {
              ...
              createBaseVNode("div", _hoisted_50, [
                createBaseVNode("label", null, toDisplayString(unref(__$1)("Name", "google-analytics-dashboard-for-wp")), 1),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => newNote.value.note_title = $event),
                  type: "text",
                  class: normalizeClass(["exactmetrics-site-note-input", { "exactmetrics-site-note-input--error": createError.value }]),
                  placeholder: unref(__$1)("e.g. Checkout Funnel", "google-analytics-dashboard-for-wp"),
                  disabled: isSaving.value,
              ...
              createBaseVNode("div", _hoisted_53, [
                createBaseVNode("label", null, toDisplayString(unref(__$1)("Category", "google-analytics-dashboard-for-wp")), 1),
                createBaseVNode("div", _hoisted_54, [
                  withDirectives(createBaseVNode("select", {
                    "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => newNote.value.category.id = $event),
                    disabled: isSaving.value
                  }, [
                    createBaseVNode("option", _hoisted_56, toDisplayString(unref(__$1)("Select Category", "google-analytics-dashboard-for-wp")), 1),
                    (openBlock(true), createElementBlock(Fragment, null, renderList(unref(siteNotesStore).categories, (category) => {
                      return openBlock(), createElementBlock("option", {
                        key: category.id,
                        value: category.id
            ...
            createBaseVNode("div", _hoisted_58, [
              ...
              }, toDisplayString(unref(__$1)("Cancel", "google-analytics-dashboard-for-wp")), 9, _hoisted_59),
              createBaseVNode("button", {
                class: "exactmetrics-button",
                disabled: isSaving.value,
                onClick: createNote
              }, toDisplayString(unref(__$1)("Create Note", "google-analytics-dashboard-for-wp")), 9, _hoisted_60)
            ])
          ])
        ]))
      ]);
...
const _hoisted_1$9 = { class: "exactmetrics-traffic-chart-metrics-dropdown__grid" };
const _hoisted_2$9 = ["onClick"];
const _hoisted_3$9 = { class: "exactmetrics-traffic-chart-metrics-dropdown__checkbox" };
const _sfc_main$b = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: "exactmetrics-traffic-chart-metrics-dropdown",
        ref_key: "dropdownRef",
        ref: dropdownRef
      }, [
        createBaseVNode("button", {
          type: "button",
          class: "exactmetrics-traffic-chart-metrics-dropdown__trigger",
          onClick: toggleOpen
        }, [
        ...
        __props.open ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "exactmetrics-traffic-chart-metrics-dropdown__menu",
          ...
          createBaseVNode("div", _hoisted_1$9, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.metricsOptions, (option) => {
              return openBlock(), createElementBlock("button", {
                key: option.id,
                type: "button",
                class: normalizeClass(["exactmetrics-traffic-chart-metrics-dropdown__item", {
                  "exactmetrics-traffic-chart-metrics-dropdown__item--selected": pendingSelection.value.includes(option.id),
                  "exactmetrics-traffic-chart-metrics-dropdown__item--pro-only": isProOnlyMetric(option.id)
                }]),
          ...
          createBaseVNode("div", { class: "exactmetrics-traffic-chart-metrics-dropdown__footer" }, [
            createBaseVNode("button", {
              type: "button",
              class: "exactmetrics-traffic-chart-metrics-dropdown__btn exactmetrics-traffic-chart-metrics-dropdown__btn--reset",
              onClick: onReset
            }, " Reset Filters "),
            createBaseVNode("button", {
              type: "button",
              class: "exactmetrics-traffic-chart-metrics-dropdown__btn exactmetrics-traffic-chart-metrics-dropdown__btn--apply",
              onClick: onApply
            }, " Apply Filters ")
          ])
        ])) : createCommentVNode("", true)
...
const _hoisted_1$8 = {
  key: 0,
  class: "exactmetrics-ecommerce-upsell-overlay"
};
const _hoisted_2$8 = { class: "exactmetrics-ecommerce-upsell-overlay__content" };
const _hoisted_3$8 = { class: "exactmetrics-ecommerce-upsell-overlay__text-section" };
const _hoisted_4$7 = { class: "exactmetrics-ecommerce-upsell-overlay__title" };
const _hoisted_5$7 = { class: "exactmetrics-ecommerce-upsell-overlay__integrations" };
const _hoisted_6$7 = ["src", "alt"];
const _hoisted_7$7 = { class: "exactmetrics-ecommerce-upsell-overlay__description" };
const _hoisted_8$7 = { class: "exactmetrics-ecommerce-upsell-overlay__actions" };
const _hoisted_9$6 = { class: "exactmetrics-ecommerce-upsell-overlay__coupon" };
const _hoisted_10$5 = { class: "exactmetrics-ecommerce-upsell-overlay__coupon-label" };
const _hoisted_11$5 = { class: "exactmetrics-ecommerce-upsell-overlay__coupon-code" };
const _hoisted_12$5 = {
  key: 0,
  class: "exactmetrics-ecommerce-upsell-overlay__copied-toast"
};
...
const _sfc_main$a = {
  ...
  setup(__props) {
    ...
    const upsellText = {
      title: __$1("Upgrade to ExactMetrics Pro to Unlock More Actionable Insights", "google-analytics-dashboard-for-wp"),
      titleLine2: __$1("& Save 50% OFF!", "google-analytics-dashboard-for-wp"),
      description: __$1("It's easy to double your traffic and sales when you know exactly how people find and use your website. ExactMetrics Pro shows you the stats that matter!", "google-analytics-dashboard-for-wp"),
      couponLabel: __$1("SAVE 50% Coupon Code", "google-analytics-dashboard-for-wp"),
      upgradeToPro: __$1("Upgrade to Pro", "google-analytics-dashboard-for-wp")
    };
    const copiedLabel = __$1("Copied!", "google-analytics-dashboard-for-wp");
    const upgradeUrl = computed(() => {
      return getUpgradeUrl("ecommerce-upsell-overlay", "overview-report", "https://www.exactmetrics.com/lite/");
    });
    ...
    return (_ctx, _cache) => {
      return __props.show ? (openBlock(), createElementBlock("div", _hoisted_1$8, [
        _cache[1] || (_cache[1] = createBaseVNode("div", { class: "exactmetrics-ecommerce-upsell-overlay__backdrop" }, null, -1)),
        createBaseVNode("div", _hoisted_2$8, [
            ...
            createBaseVNode("div", _hoisted_5$7, [
              (openBlock(), createElementBlock(Fragment, null, renderList(integrationLogos, (logo) => {
                return createBaseVNode("div", {
                  key: logo.name,
                  class: "exactmetrics-ecommerce-upsell-overlay__logo-card"
                }, [
                  createBaseVNode("img", {
                    src: logo.src,
                    alt: logo.name
          ...
          createBaseVNode("div", _hoisted_8$7, [
            createBaseVNode("div", _hoisted_9$6, [
              ...
              createBaseVNode("button", {
                type: "button",
                class: "exactmetrics-ecommerce-upsell-overlay__coupon-copy",
            ...
            createBaseVNode("a", {
              ...
              target: "_blank",
              rel: "noopener",
              class: "exactmetrics-ecommerce-upsell-overlay__btn"
            }, [
...
const OVERVIEW_METRIC_DISPLAY = {
  totalUsers: { id: "totalUsers", label: __$1("Total Users", "google-analytics-dashboard-for-wp") },
  screenPageViews: { id: "screenPageViews", label: __$1("Page Views", "google-analytics-dashboard-for-wp") },
  sessions: { id: "sessions", label: __$1("Sessions", "google-analytics-dashboard-for-wp") },
  bounceRate: { id: "bounceRate", label: __$1("Bounce Rate", "google-analytics-dashboard-for-wp") },
  ecommercePurchases: { id: "ecommercePurchases", label: __$1("eCommerce Purchases", "google-analytics-dashboard-for-wp") },
  itemsPurchased: { id: "itemsPurchased", label: __$1("Items Purchased", "google-analytics-dashboard-for-wp") },
  averagePurchaseRevenue: { id: "averagePurchaseRevenue", label: __$1("Revenue/Sales", "google-analytics-dashboard-for-wp") },
  newUsers: { id: "newUsers", label: __$1("New Users", "google-analytics-dashboard-for-wp") },
  engagementRate: { id: "engagementRate", label: __$1("Engagement Rate", "google-analytics-dashboard-for-wp") },
  engagedSessions: { id: "engagedSessions", label: __$1("Engaged Sessions", "google-analytics-dashboard-for-wp") },
  sessionKeyEventRate: { id: "sessionKeyEventRate", label: __$1("Key Event Rate", "google-analytics-dashboard-for-wp") },
  totalRevenue: { id: "totalRevenue", label: __$1("Revenue", "google-analytics-dashboard-for-wp") },
  returningUsers: { id: "returningUsers", label: __$1("Returning Users", "google-analytics-dashboard-for-wp") },
  pageViewsPerUser: { id: "pageViewsPerUser", label: __$1("Pageviews / User", "google-analytics-dashboard-for-wp") },
  averageSessionDuration: { id: "averageSessionDuration", label: __$1("Session Duration", "google-analytics-dashboard-for-wp") },
  couponUsedPercent: { id: "couponUsedPercent", label: __$1("Coupon Used %", "google-analytics-dashboard-for-wp") },
  cartAbandonRatePercent: { id: "cartAbandonRatePercent", label: __$1("Cart Abandon Rate %", "google-analytics-dashboard-for-wp") }
};
...
const PREVIOUS_PERIOD_LEGEND_LABEL = __$1("Previous Period", "google-analytics-dashboard-for-wp");
...
const METRIC_DISPLAY_CONFIG = {
  totalUsers: { label: __$1("Total Users", "google-analytics-dashboard-for-wp"), type: "number", key: "totalUsers" },
  newUsers: { label: __$1("New Users", "google-analytics-dashboard-for-wp"), type: "number", key: "newUsers" },
  returningUsers: { label: __$1("Returning Users", "google-analytics-dashboard-for-wp"), type: "number", key: "returningUsers" },
  engagementRate: { label: __$1("Engagement Rate", "google-analytics-dashboard-for-wp"), type: "percent", key: "engagementRate" },
  pageViewsPerUser: { label: __$1("Pageviews / User", "google-analytics-dashboard-for-wp"), type: "decimal", key: "pageViewsPerUser" },
  bounceRate: { label: __$1("Bounce Rate", "google-analytics-dashboard-for-wp"), type: "percent", key: "bounceRate" },
  ecommercePurchases: { label: __$1("Purchases", "google-analytics-dashboard-for-wp"), type: "number", key: "ecommercePurchases" },
  totalRevenue: { label: __$1("Revenue", "google-analytics-dashboard-for-wp"), type: "currency", key: "totalRevenue" },
  averagePurchaseRevenue: { label: __$1("Average Order Value", "google-analytics-dashboard-for-wp"), type: "currency", key: "averagePurchaseRevenue" },
  averageSessionDuration: { label: __$1("Session Duration", "google-analytics-dashboard-for-wp"), type: "duration", key: "averageSessionDuration" },
  sessions: { label: __$1("Sessions", "google-analytics-dashboard-for-wp"), type: "number", key: "sessions" },
  engagedSessions: { label: __$1("Engaged Sessions", "google-analytics-dashboard-for-wp"), type: "number", key: "engagedSessions" },
  sessionKeyEventRate: { label: __$1("Key Event Rate", "google-analytics-dashboard-for-wp"), type: "percent", key: "sessionKeyEventRate" },
  screenPageViews: { label: __$1("Page Views", "google-analytics-dashboard-for-wp"), type: "number", key: "screenPageViews" },
  itemsPurchased: { label: __$1("Items Purchased", "google-analytics-dashboard-for-wp"), type: "number", key: "ecommercePurchases" },
  couponUsedPercent: { label: __$1("Coupon Used %", "google-analytics-dashboard-for-wp"), type: "percent", key: "couponUsedPercent" },
  cartAbandonRatePercent: { label: __$1("Cart Abandon Rate %", "google-analytics-dashboard-for-wp"), type: "percent", key: "cartAbandonRatePercent" }
};
...
function getMetricsForTab(tabId, metrics = {}) {
  const tabMetrics = {
    traffic: [
      { id: "totalUsers", label: __$1("Total Users", "google-analytics-dashboard-for-wp"), value: metrics.totalUsers || 0, type: "number" },
      { id: "newUsers", label: __$1("New Users", "google-analytics-dashboard-for-wp"), value: metrics.newUsers || 0, type: "number" },
      { id: "returningUsers", label: __$1("Returning Users", "google-analytics-dashboard-for-wp"), value: metrics.returningUsers || 0, type: "number" },
      { id: "engagementRate", label: __$1("Engagement Rate", "google-analytics-dashboard-for-wp"), value: metrics.engagementRate || 0, type: "percent" }
    ],
    engagement: [
      { id: "sessions", label: __$1("Sessions", "google-analytics-dashboard-for-wp"), value: metrics.sessions || 0, type: "number" },
      { id: "pageViews", label: __$1("Page Views", "google-analytics-dashboard-for-wp"), value: metrics.pageViews || 0, type: "number" },
      { id: "avgSessionDuration", label: __$1("Avg. Session Duration", "google-analytics-dashboard-for-wp"), value: metrics.avgSessionDuration || 0, type: "duration" },
      { id: "bounceRate", label: __$1("Bounce Rate", "google-analytics-dashboard-for-wp"), value: metrics.bounceRate || 0, type: "percent" }
    ],
    referrals: [
      { id: "sessions", label: __$1("Sessions", "google-analytics-dashboard-for-wp"), value: metrics.sessions || 0, type: "number" },
      { id: "engagedSessions", label: __$1("Engaged Sessions", "google-analytics-dashboard-for-wp"), value: metrics.engagedSessions || 0, type: "number" },
      { id: "sessionKeyEventRate", label: __$1("Session Key Event Rate", "google-analytics-dashboard-for-wp"), value: metrics.sessionKeyEventRate || 0, type: "percent" }
    ],
    ecommerce: [
      { id: "revenue", label: __$1("Revenue", "google-analytics-dashboard-for-wp"), value: metrics.revenue || 0, type: "currency" },
      { id: "transactions", label: __$1("Transactions", "google-analytics-dashboard-for-wp"), value: metrics.transactions || 0, type: "number" },
      { id: "avgOrderValue", label: __$1("Avg. Order Value", "google-analytics-dashboard-for-wp"), value: metrics.avgOrderValue || 0, type: "currency" },
      { id: "conversionRate", label: __$1("Conversion Rate", "google-analytics-dashboard-for-wp"), value: metrics.conversionRate || 0, type: "percent" }
    ]
  };
...
const _hoisted_1$7 = { class: "exactmetrics-overview-report-traffic-chart-section" };
const _hoisted_2$7 = { class: "exactmetrics-overview-report-traffic-chart-tabs" };
const _hoisted_3$7 = ["onClick"];
const _hoisted_4$6 = { class: "exactmetrics-overview-tab__label" };
const _hoisted_5$6 = { class: "exactmetrics-traffic-chart-key-metrics" };
const _hoisted_6$6 = { class: "exactmetrics-traffic-chart-key-metrics__row" };
const _hoisted_7$6 = { class: "exactmetrics-traffic-chart-key-metrics__container" };
const _hoisted_8$6 = { class: "exactmetrics-overview-metric__label" };
const _hoisted_9$5 = { class: "exactmetrics-overview-metric__value-wrap" };
const _hoisted_10$4 = { class: "exactmetrics-overview-metric__value" };
const _hoisted_11$4 = {
  key: 1,
  class: "exactmetrics-overview-metric__date-range"
};
const _hoisted_12$4 = {
  key: 0,
  class: "exactmetrics-traffic-chart-key-metrics__previous"
};
const _hoisted_13$3 = { class: "exactmetrics-traffic-chart-key-metrics__container exactmetrics-traffic-chart-key-metrics__container--previous" };
const _hoisted_14$3 = { class: "exactmetrics-overview-metric__label" };
const _hoisted_15$3 = { class: "exactmetrics-overview-metric__value-wrap" };
const _hoisted_16$3 = { class: "exactmetrics-overview-metric__value" };
const _hoisted_17$3 = {
  key: 0,
  class: "exactmetrics-overview-metric__date-range"
};
const _hoisted_18$3 = { class: "exactmetrics-traffic-chart-legends" };
const _hoisted_19$3 = { class: "exactmetrics-traffic-chart-legend__label" };
const _hoisted_20$3 = { class: "exactmetrics-overview-report-traffic-chart-wrapper" };
const _hoisted_21$2 = {
  key: 0,
  class: "exactmetrics-overview-chart-loading"
};
const _hoisted_22$2 = {
  key: 1,
  class: "exactmetrics-overview-chart-error"
};
const _hoisted_23$1 = { class: "exactmetrics-site-notes-toggle" };
const _hoisted_24$1 = {
  key: 1,
  class: "exactmetrics-site-notes-toggle"
};
const _sfc_main$9 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const SAMPLE_KEY_METRICS_BY_TAB = {
      traffic: [
        { id: "totalUsers", label: __$1("Total Users", "google-analytics-dashboard-for-wp"), value: 8432, type: "number", percentChange: { value: 14.2, positive: true } },
        { id: "newUsers", label: __$1("New Users", "google-analytics-dashboard-for-wp"), value: 6218, type: "number", percentChange: { value: 11.5, positive: true } },
        { id: "engagementRate", label: __$1("Engagement Rate", "google-analytics-dashboard-for-wp"), value: 62.3, type: "percent", percentChange: { value: 4.8, positive: true } }
      ],
      engagement: [
        { id: "newUsers", label: __$1("New Users", "google-analytics-dashboard-for-wp"), value: 6218, type: "number", percentChange: { value: 11.5, positive: true } },
        { id: "returningUsers", label: __$1("Returning Users", "google-analytics-dashboard-for-wp"), value: 2214, type: "number", percentChange: { value: 7.3, positive: true } },
        { id: "engagementRate", label: __$1("Engagement Rate", "google-analytics-dashboard-for-wp"), value: 62.3, type: "percent", percentChange: { value: 4.8, positive: true } }
      ],
      referrals: [
        { id: "totalUsers", label: __$1("Total Users", "google-analytics-dashboard-for-wp"), value: 3150, type: "number", percentChange: { value: 9.6, positive: true } },
        { id: "newUsers", label: __$1("New Users", "google-analytics-dashboard-for-wp"), value: 2340, type: "number", percentChange: { value: 6.1, positive: true } },
        { id: "engagementRate", label: __$1("Engagement Rate", "google-analytics-dashboard-for-wp"), value: 58.7, type: "percent", percentChange: { value: 3.2, positive: true } }
      ],
      ecommerce: [
        { id: "revenue", label: __$1("Revenue", "google-analytics-dashboard-for-wp"), value: 12450, type: "currency", percentChange: { value: 18.4, positive: true } },
        { id: "transactions", label: __$1("Transactions", "google-analytics-dashboard-for-wp"), value: 184, type: "number", percentChange: { value: 12.1, positive: true } },
        { id: "avgOrderValue", label: __$1("Avg. Order Value", "google-analytics-dashboard-for-wp"), value: 67.66, type: "currency", percentChange: { value: 5.3, positive: true } },
        { id: "conversionRate", label: __$1("Conversion Rate", "google-analytics-dashboard-for-wp"), value: 2.4, type: "percent", percentChange: { value: 8.7, positive: true } }
      ]
    };
    ...
    const METRICS_OPTIONS_BY_TAB = {
      traffic: [
        { id: "sessions", label: __$1("Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "engagedSessions", label: __$1("Engaged Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "sessionKeyEventRate", label: __$1("Key Event Rate", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "totalUsers", label: __$1("Total Users", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "newUsers", label: __$1("New Users", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "returningUsers", label: __$1("Returning Users", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "engagementRate", label: __$1("Engagement Rate", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "pageViewsPerUser", label: __$1("Pageviews / User", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "bounceRate", label: __$1("Bounce Rate", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "ecommercePurchases", label: __$1("Purchases", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "totalRevenue", label: __$1("Revenue", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "averagePurchaseRevenue", label: __$1("Average Order Value", "google-analytics-dashboard-for-wp"), icon: "link" }
      ],
      engagement: [
        { id: "sessions", label: __$1("Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "engagedSessions", label: __$1("Engaged Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
        ...
        { id: "pageViewsPerUser", label: __$1("Pageviews / User", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "bounceRate", label: __$1("Bounce Rate", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "averageSessionDuration", label: __$1("Session Duration", "google-analytics-dashboard-for-wp"), icon: "link" }
      ],
      referrals: [
        { id: "sessions", label: __$1("Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "engagedSessions", label: __$1("Engaged Sessions", "google-analytics-dashboard-for-wp"), icon: "link" },
      ...
      ecommerce: [
        { id: "itemsPurchased", label: __$1("Items Purchased", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "averagePurchaseRevenue", label: __$1("Average Order Value (AOV)", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "couponUsedPercent", label: __$1("Coupon Used %", "google-analytics-dashboard-for-wp"), icon: "link" },
        { id: "cartAbandonRatePercent", label: __$1("Cart Abandon Rate %", "google-analytics-dashboard-for-wp"), icon: "link" }
      ]
    };
    ...
    const TAB_DEFINITIONS = [
      { id: "traffic", label: __$1("Traffic", "google-analytics-dashboard-for-wp"), icon: "chart-line" },
      { id: "engagement", label: __$1("Engagement", "google-analytics-dashboard-for-wp"), icon: "users" },
      { id: "referrals", label: __$1("Referrals", "google-analytics-dashboard-for-wp"), icon: "referrals" },
      { id: "ecommerce", label: __$1("eCommerce", "google-analytics-dashboard-for-wp"), icon: "cart" }
    ];
      ...
      return {
        ...
        tooltip: {
          ...
          custom({ series, seriesIndex, dataPointIndex, w }) {
            ...
            let html = '<div class="exactmetrics-chart-tooltip">';
            html += '<div class="exactmetrics-chart-tooltip__date">' + categoryLabel + "</div>";
            for (let i = 0; i < series.length; i++) {
              ...
              html += '<div class="exactmetrics-chart-tooltip__row">';
              html += '<span class="exactmetrics-chart-tooltip__dot" style="background:' + color + '"></span>';
              html += '<span class="exactmetrics-chart-tooltip__label">' + seriesName + ": </span>";
              html += '<span class="exactmetrics-chart-tooltip__value">' + displayValue + "</span>";
              html += "</div>";
            }
            const rawDates = chartRawDates.value;
            const notesByDate = siteNotesStore.siteNotesByDateCompact;
            if (rawDates.length > dataPointIndex) {
              ...
              if (dayNotes && dayNotes.length) {
                html += '<div class="exactmetrics-chart-tooltip__notes"><hr />';
    ...
    function applySinglePointLine() {
      ...
      baseEl.querySelector(".exactmetrics-single-point-line")?.remove();
      ...
      line.classList.add("exactmetrics-single-point-line");
    ...
    async function loadOverviewData() {
      ...
      try {
        ...
        if (currentLoadId !== overviewLoadId.value) return;
        if (!isUpsell) {
          error.value = err?.message || err?.title || __$1("Error loading overview data.", "google-analytics-dashboard-for-wp");
        }
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$7, [
        createBaseVNode("div", _hoisted_2$7, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(activeTabs.value, (tab) => {
            return openBlock(), createElementBlock("button", {
              key: tab.id,
              type: "button",
              class: normalizeClass(["exactmetrics-overview-tab", { "exactmetrics-overview-tab--active": activeTab.value === tab.id }]),
        ...
        createBaseVNode("div", {
          class: normalizeClass(["exactmetrics-overview-report-traffic-chart-content", { "exactmetrics-overview-report-traffic-chart-content--has-overlay": showProUpsell.value }])
        }, [
            ...
            createBaseVNode("div", _hoisted_6$6, [
              createBaseVNode("div", _hoisted_7$6, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(displayKeyMetricsWithChange.value, (metric, index) => {
                  return openBlock(), createElementBlock("div", {
                    key: metric.id,
                    class: normalizeClass(["exactmetrics-overview-metric", { "exactmetrics-overview-metric--highlighted": index === 0 }])
                  }, [
                    ...
                    createBaseVNode("div", _hoisted_9$5, [
                      ...
                      metric.percentChange ? (openBlock(), createElementBlock("span", {
                        key: 0,
                        class: normalizeClass(["exactmetrics-overview-metric__percent-change", metric.percentChange.positive ? "exactmetrics-overview-metric__percent-change--positive" : "exactmetrics-overview-metric__percent-change--negative"])
            ...
            isCompareActive.value && unref(keyMetricsPrevious).length > 0 ? (openBlock(), createElementBlock("div", _hoisted_12$4, [
              createBaseVNode("div", _hoisted_13$3, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(unref(keyMetricsPrevious), (metric, index) => {
                  return openBlock(), createElementBlock("div", {
                    key: metric.id,
                    class: "exactmetrics-overview-metric exactmetrics-overview-metric--previous"
                  }, [
          ...
          createBaseVNode("div", _hoisted_18$3, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(chartLegends), (legend) => {
              return openBlock(), createElementBlock("div", {
                class: "exactmetrics-traffic-chart-legend",
                key: legend.id
              }, [
                createBaseVNode("span", {
                  class: "exactmetrics-traffic-chart-legend__dot",
        ...
        createBaseVNode("div", _hoisted_23$1, [
          !unref(siteNotesStore).showSiteNotes ? (openBlock(), createElementBlock("button", {
            key: 0,
            type: "button",
            class: "exactmetrics-site-notes-toggle__btn",
            ...
            createBaseVNode("span", null, toDisplayString(unref(__$1)("Site Notes", "google-analytics-dashboard-for-wp")), 1)
          ])) : createCommentVNode("", true)
        ]),
        ...
        unref(siteNotesStore).showSiteNotes ? (openBlock(), createElementBlock("div", _hoisted_24$1, [
          createBaseVNode("button", {
            ...
            createBaseVNode("span", null, toDisplayString(unref(__$1)("Close Site Notes", "google-analytics-dashboard-for-wp")), 1)
          ])
        ])) : createCommentVNode("", true)
      ]);
    };
...
const _hoisted_1$6 = { class: "exactmetrics-overview-key-metrics" };
const _hoisted_2$6 = { class: "exactmetrics-overview-key-metrics__header" };
const _hoisted_3$6 = { class: "exactmetrics-overview-key-metrics__title" };
const _hoisted_4$5 = ["href"];
const _hoisted_5$5 = { class: "exactmetrics-overview-key-metrics__container" };
const _hoisted_6$5 = { class: "exactmetrics-overview-key-metrics__item" };
const _hoisted_7$5 = { class: "exactmetrics-overview-key-metrics__label" };
const _hoisted_8$5 = { class: "exactmetrics-overview-key-metrics__value-row" };
const _hoisted_9$4 = { class: "exactmetrics-overview-key-metrics__value" };
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    const KEY_METRICS_BY_TAB = {
      traffic: [
        { id: "organic", label: __$1("Organic Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true },
        { id: "social", label: __$1("Social Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true },
        { id: "paid", label: __$1("Paid Media Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true },
        { id: "email", label: __$1("Email Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true },
        { id: "referral", label: __$1("Referral Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true },
        { id: "direct", label: __$1("Direct Sessions", "google-analytics-dashboard-for-wp"), channelGroup: true }
      ],
      engagement: [
        { id: "sessions", label: __$1("Sessions", "google-analytics-dashboard-for-wp"), apiKey: "sessions" },
        { id: "engagementRate", label: __$1("Engagement Rate", "google-analytics-dashboard-for-wp"), apiKey: "engagementRate", type: "percent" },
        { id: "bounceRate", label: __$1("Bounce Rate", "google-analytics-dashboard-for-wp"), apiKey: "bounceRate", type: "percent" },
        { id: "newUsers", label: __$1("New Users", "google-analytics-dashboard-for-wp"), apiKey: "newUsers" },
        { id: "returningUsers", label: __$1("Returning Users", "google-analytics-dashboard-for-wp"), apiKey: "returningUsers" },
        { id: "sessionDuration", label: __$1("Session Duration", "google-analytics-dashboard-for-wp"), apiKey: "averageSessionDuration", type: "duration" }
      ],
      referrals: [
        { id: "sessions", label: __$1("Sessions", "google-analytics-dashboard-for-wp"), apiKey: "sessions" },
        { id: "engagedSessions", label: __$1("Engaged Sessions", "google-analytics-dashboard-for-wp"), apiKey: "engagedSessions" },
        { id: "users", label: __$1("Users", "google-analytics-dashboard-for-wp"), apiKey: "totalUsers" }
      ],
      ecommerce: [
        { id: "transactions", label: __$1("Transactions", "google-analytics-dashboard-for-wp"), apiKey: "ecommercePurchases" },
        { id: "revenue", label: __$1("Revenue", "google-analytics-dashboard-for-wp"), apiKey: "totalRevenue", type: "currency" },
        { id: "aov", label: __$1("AOV", "google-analytics-dashboard-for-wp"), apiKey: "averagePurchaseRevenue", type: "currency" },
        { id: "addToCarts", label: __$1("Add to Carts", "google-analytics-dashboard-for-wp"), apiKey: "addToCarts" },
        { id: "conversionRate", label: __$1("Conversion Rate", "google-analytics-dashboard-for-wp"), apiKey: "conversionRate", type: "percent" },
        { id: "abandonmentRate", label: __$1("Abandonment Rate", "google-analytics-dashboard-for-wp"), apiKey: "abandonmentRate", type: "percent" }
      ]
    };
    ...
    const getTrendClass = (trend) => {
      ...
      return trend >= 0 ? "exactmetrics-overview-key-metrics__trend--positive" : "exactmetrics-overview-key-metrics__trend--negative";
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$6, [
        createBaseVNode("div", _hoisted_2$6, [
          createBaseVNode("h2", _hoisted_3$6, toDisplayString(unref(__$1)("Key Metrics", "google-analytics-dashboard-for-wp")), 1),
          __props.viewFullReportUrl ? (openBlock(), createElementBlock("a", {
            key: 0,
            href: __props.viewFullReportUrl,
            class: "exactmetrics-overview-key-metrics__link"
          }, [
            createBaseVNode("span", null, toDisplayString(unref(__$1)("View Full Report", "google-analytics-dashboard-for-wp")), 1),
            createVNode(Icon, {
              name: "chevron-right",
              size: 20
            })
        ...
        createBaseVNode("div", _hoisted_5$5, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(metrics.value, (metric) => {
            return openBlock(), createElementBlock("div", {
              key: metric.id,
              class: "exactmetrics-overview-key-metrics__item-wrapper"
            }, [
              createBaseVNode("div", _hoisted_6$5, [
                ...
                createBaseVNode("div", _hoisted_8$5, [
                  ...
                  metric.trend != null ? (openBlock(), createElementBlock("div", {
                    key: 0,
                    class: normalizeClass(["exactmetrics-overview-key-metrics__trend", getTrendClass(metric.trend)])
                  }, [
                    createVNode(Icon, {
...
const _hoisted_1$5 = {
  ...
  class: "exactmetrics-report-table-modal__title"
};
const _hoisted_2$5 = { class: "exactmetrics-report-table-modal__search" };
const _hoisted_3$5 = ["placeholder"];
const _hoisted_4$4 = { class: "exactmetrics-report-table-modal__table-wrapper" };
const _hoisted_5$4 = { class: "exactmetrics-report-table-modal__table-scroll" };
const _hoisted_6$4 = { class: "exactmetrics-report-table-modal__table" };
const _hoisted_7$4 = ["onClick"];
const _hoisted_8$4 = { class: "exactmetrics-report-table-modal__th-content" };
const _hoisted_9$3 = {
  key: 0,
  class: "exactmetrics-report-table-modal__cell-with-icon"
};
const _hoisted_10$3 = { key: 1 };
const _hoisted_11$3 = { key: 0 };
const _hoisted_12$3 = { class: "exactmetrics-report-table-modal__totals-row" };
const _sfc_main$7 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const gradientColors = (() => {
      {
        return { c1: "#DED8FF", c2: "#F9E1FF", c3: "#FFFFFF" };
      }
    })();
    ...
    const totals = computed(() => {
      ...
      result[firstCol.key] = props.totalLabel || __$1("Totals", "google-analytics-dashboard-for-wp");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(Teleport, { to: "body" }, [
        __props.modelValue ? (openBlock(), createElementBlock("div", {
          key: 0,
          class: "exactmetrics-report-table-modal-overlay",
          onClick: withModifiers(close, ["self"])
        }, [
          createBaseVNode("div", {
            class: "exactmetrics-report-table-modal",
            ref_key: "dialogRef",
            ref: dialogRef,
            role: "dialog",
            "aria-modal": "true",
            ...
            createBaseVNode("button", {
              type: "button",
              class: "exactmetrics-report-table-modal__close",
            ...
            createBaseVNode("div", _hoisted_2$5, [
              createVNode(Icon, {
                name: "search",
                size: 16,
                class: "exactmetrics-report-table-modal__search-icon"
              }),
              withDirectives(createBaseVNode("input", {
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => searchQuery.value = $event),
                type: "text",
                class: "exactmetrics-report-table-modal__search-input",
                placeholder: unref(__$1)("Search", "google-analytics-dashboard-for-wp")
              }, null, 8, _hoisted_3$5), [
                    ...
                    createBaseVNode("tr", null, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(__props.columns, (column) => {
                        return openBlock(), createElementBlock("th", {
                          key: column.key,
                          class: normalizeClass({ "exactmetrics-report-table-modal__th--sortable": column.sortable !== false }),
...
const _hoisted_1$4 = { class: "exactmetrics-overview-report-table" };
const _hoisted_2$4 = { class: "exactmetrics-overview-report-table__header" };
const _hoisted_3$4 = { class: "exactmetrics-overview-report-table__title" };
const _hoisted_4$3 = {
  key: 0,
  class: "exactmetrics-overview-report-table__demo-badge"
};
const _hoisted_5$3 = { class: "exactmetrics-overview-report-table__header-right" };
const _hoisted_6$3 = {
  key: 0,
  class: "exactmetrics-overview-report-table__tabs"
};
const _hoisted_7$3 = ["onClick"];
const _hoisted_8$3 = {
  key: 0,
  class: "exactmetrics-overview-report-table__tab-divider"
};
const _hoisted_9$2 = ["href"];
const _hoisted_10$2 = { class: "exactmetrics-overview-report-table__table-wrapper" };
const _hoisted_11$2 = { class: "exactmetrics-overview-report-table__table" };
const _hoisted_12$2 = ["onClick"];
const _hoisted_13$2 = { class: "exactmetrics-overview-report-table__th-content" };
const _hoisted_14$2 = {
  key: 0,
  class: "exactmetrics-overview-report-table__row--loading"
};
const _hoisted_15$2 = ["colspan"];
const _hoisted_16$2 = {
  key: 1,
  class: "exactmetrics-overview-report-table__row--empty"
};
const _hoisted_17$2 = ["colspan"];
const _hoisted_18$2 = {
  key: 0,
  class: "exactmetrics-overview-report-table__cell-with-icon"
};
const _hoisted_19$2 = { key: 1 };
const _hoisted_20$2 = {
  key: 0,
  class: "exactmetrics-overview-report-table__load-more"
};
const _sfc_main$6 = {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$4, [
        createBaseVNode("div", _hoisted_2$4, [
          createBaseVNode("h3", _hoisted_3$4, [
            ...
            needsAddonGate.value ? (openBlock(), createElementBlock("span", _hoisted_4$3, toDisplayString(unref(__$1)("Demo Data", "google-analytics-dashboard-for-wp")), 1)) : createCommentVNode("", true)
          ]),
          createBaseVNode("div", _hoisted_5$3, [
                ...
                return openBlock(), createElementBlock(Fragment, {
                  ...
                  createBaseVNode("button", {
                    class: normalizeClass([
                      "exactmetrics-overview-report-table__tab",
                      { "exactmetrics-overview-report-table__tab--active": tab.value === __props.activeTab }
                    ]),
            ...
            __props.showViewFullReport && __props.viewFullReportUrl ? (openBlock(), createElementBlock("a", {
              key: 1,
              href: __props.viewFullReportUrl,
              class: "exactmetrics-overview-report-table__view-link"
            }, [
              createBaseVNode("span", null, toDisplayString(unref(__$1)("View Full Report", "google-analytics-dashboard-for-wp")), 1),
              createVNode(Icon, {
                name: "chevron-right",
        ...
        createBaseVNode("div", _hoisted_10$2, [
            ...
            createBaseVNode("thead", null, [
              createBaseVNode("tr", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(__props.columns, (column) => {
                  return openBlock(), createElementBlock("th", {
                    key: column.key,
                    class: normalizeClass({ "exactmetrics-overview-report-table__th--sortable": column.sortable !== false }),
                    onClick: ($event) => handleColumnHeaderClick(column)
                  }, [
            ...
            createBaseVNode("tbody", null, [
              __props.loading ? (openBlock(), createElementBlock("tr", _hoisted_14$2, [
                createBaseVNode("td", {
                  ...
                  class: "exactmetrics-overview-report-table__cell-loading"
                }, [
                  createVNode(LoadingSpinnerInline),
                  createBaseVNode("span", null, toDisplayString(unref(__$1)("Loading…", "google-analytics-dashboard-for-wp")), 1)
                ], 8, _hoisted_15$2)
              ])) : displayedRowsWithBar.value.length === 0 ? (openBlock(), createElementBlock("tr", _hoisted_16$2, [
                createBaseVNode("td", {
                  colspan: __props.columns.length,
                  class: "exactmetrics-overview-report-table__cell-empty"
                }, toDisplayString(unref(__$1)("No data available", "google-analytics-dashboard-for-wp")), 9, _hoisted_17$2)
          ...
          __props.hasLoadMore && (__props.rows.length > __props.rowLimit || needsAddonGate.value) ? (openBlock(), createElementBlock("div", _hoisted_20$2, [
            createBaseVNode("button", {
              class: "exactmetrics-overview-report-table__load-more-btn",
              onClick: handleLoadMoreClick
            }, [
              createBaseVNode("span", null, toDisplayString(unref(__$1)("Load More", "google-analytics-dashboard-for-wp")), 1),
              createVNode(Icon, {
                name: "load-more",
                size: 16
              })
      ...
      return openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", _hoisted_1$3, [
          ...
          createBaseVNode("a", {
            ...
            target: "_blank",
            rel: "noopener",
            class: "exactmetrics-overview-upsell-cta__btn"
          }, [
          ...
          createBaseVNode("img", {
            ...
            class: "exactmetrics-overview-upsell-cta__arrow",
            alt: ""
          }, null, 8, _hoisted_6$2)
        ]),
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const text = {
      customDimensions: __$1("Custom Dimensions", "google-analytics-dashboard-for-wp")
    };
    const viewFullReportUrls = {
      dimensions: "/wp-admin/admin.php?page=exactmetrics_reports#/dimensions"
    };
    const customDimensionsTabs = [
      { label: __$1("Logged In", "google-analytics-dashboard-for-wp"), value: "loggedIn" },
      { label: __$1("Post Type", "google-analytics-dashboard-for-wp"), value: "postType" },
      { label: __$1("Author", "google-analytics-dashboard-for-wp"), value: "author" },
      { label: __$1("Category", "google-analytics-dashboard-for-wp"), value: "category" },
      { label: __$1("Tags", "google-analytics-dashboard-for-wp"), value: "tags" },
      { label: __$1("Focus Keyword", "google-analytics-dashboard-for-wp"), value: "focusKeyword" },
      { label: __$1("Day of Week", "google-analytics-dashboard-for-wp"), value: "dayOfWeek" },
      { label: __$1("SEO Score", "google-analytics-dashboard-for-wp"), value: "seoScore" }
    ];
    const customDimensionsActiveTab = ref("loggedIn");
    const customDimensionsColumnLabels = {
      loggedIn: __$1("Logged In", "google-analytics-dashboard-for-wp"),
      postType: __$1("Post Type", "google-analytics-dashboard-for-wp"),
      author: __$1("Author", "google-analytics-dashboard-for-wp"),
      category: __$1("Category", "google-analytics-dashboard-for-wp"),
      tags: __$1("Tags", "google-analytics-dashboard-for-wp"),
      focusKeyword: __$1("Focus Keyword", "google-analytics-dashboard-for-wp"),
      dayOfWeek: __$1("Day of Week", "google-analytics-dashboard-for-wp"),
      seoScore: __$1("SEO Score", "google-analytics-dashboard-for-wp")
    };
    const customDimensionsColumnsBase = [
      { key: "dimensionValue", label: "" },
      { key: "sessions", label: __$1("Sessions", "google-analytics-dashboard-for-wp") },
      { key: "users", label: __$1("Users", "google-analytics-dashboard-for-wp") },
      { key: "engagement", label: __$1("Engagement Rate", "google-analytics-dashboard-for-wp") },
      { key: "revenue", label: __$1("Revenue", "google-analytics-dashboard-for-wp") },
      { key: "purchases", label: __$1("Purchases", "google-analytics-dashboard-for-wp") },
      { key: "averageOrderValue", label: __$1("Average Order Value (AOV)", "google-analytics-dashboard-for-wp") },
      { key: "conversionRate", label: __$1("Conversion Rate", "google-analytics-dashboard-for-wp") }
    ];
    ...
    function parseCustomDimensionsRows(apiData) {
      ...
      if (rows.length === 0) return [];
      const empty = __$1("(not set)", "google-analytics-dashboard-for-wp");
      return rows.map((row) => {
    ...
    const DAY_OF_WEEK_NAMES = [
      __$1("Sunday", "google-analytics-dashboard-for-wp"),
      __$1("Monday", "google-analytics-dashboard-for-wp"),
      __$1("Tuesday", "google-analytics-dashboard-for-wp"),
      __$1("Wednesday", "google-analytics-dashboard-for-wp"),
      __$1("Thursday", "google-analytics-dashboard-for-wp"),
      __$1("Friday", "google-analytics-dashboard-for-wp"),
      __$1("Saturday", "google-analytics-dashboard-for-wp")
    ];
...
const _hoisted_2$2 = { class: "exactmetrics-funnel-modal__header" };
const _hoisted_3$2 = {
  id: "funnel-modal-title",
  class: "exactmetrics-funnel-modal__title"
};
const _hoisted_4$1 = { class: "exactmetrics-funnel-modal__body" };
const _hoisted_5$1 = { class: "exactmetrics-funnel-modal__create-section" };
const _hoisted_6$1 = { class: "exactmetrics-funnel-modal__section-title" };
const _hoisted_7$1 = { class: "exactmetrics-funnel-modal__name-field" };
const _hoisted_8$1 = { class: "exactmetrics-funnel-modal__field-label" };
const _hoisted_9$1 = ["placeholder"];
const _hoisted_10$1 = { class: "exactmetrics-funnel-modal__steps-section" };
const _hoisted_11$1 = { class: "exactmetrics-funnel-modal__steps-label" };
const _hoisted_12$1 = { class: "exactmetrics-funnel-modal__steps-list" };
const _hoisted_13$1 = { class: "exactmetrics-funnel-modal__step-number" };
const _hoisted_14$1 = { class: "exactmetrics-funnel-modal__select-wrapper" };
const _hoisted_15$1 = ["onUpdate:modelValue"];
const _hoisted_16$1 = ["value"];
const _hoisted_17$1 = { class: "exactmetrics-funnel-modal__step-value-wrapper" };
const _hoisted_18$1 = ["onUpdate:modelValue", "placeholder"];
const _hoisted_19$1 = ["onClick"];
const _hoisted_20$1 = { class: "exactmetrics-funnel-modal__step-actions" };
const _hoisted_21$1 = ["disabled"];
const _hoisted_22$1 = { class: "exactmetrics-funnel-modal__saved-section" };
const _hoisted_23 = { class: "exactmetrics-funnel-modal__section-title" };
const _hoisted_24 = {
  key: 0,
  class: "exactmetrics-funnel-modal__empty-state"
};
const _hoisted_25 = {
  key: 1,
  class: "exactmetrics-funnel-modal__saved-list"
};
const _hoisted_26 = ["onMouseenter"];
const _hoisted_27 = { class: "exactmetrics-funnel-modal__saved-item-header" };
const _hoisted_28 = { class: "exactmetrics-funnel-modal__saved-item-info" };
const _hoisted_29 = { class: "exactmetrics-funnel-modal__saved-item-name" };
const _hoisted_30 = { class: "exactmetrics-funnel-modal__saved-item-steps" };
const _hoisted_31 = {
  key: 0,
  class: "exactmetrics-funnel-modal__saved-item-status exactmetrics-funnel-modal__saved-item-status--applied"
};
const _hoisted_32 = ["onClick"];
const _hoisted_33 = { class: "exactmetrics-funnel-modal__saved-item-actions" };
const _hoisted_34 = {
  key: 0,
  class: "exactmetrics-funnel-modal__saved-item-status exactmetrics-funnel-modal__saved-item-status--default"
};
const _hoisted_35 = ["onClick"];
const _hoisted_36 = ["onClick"];
const _hoisted_37 = {
  key: 0,
  class: "exactmetrics-funnel-modal__saved-item-edit"
};
const _hoisted_38 = { class: "exactmetrics-funnel-modal__step-number" };
const _hoisted_39 = { class: "exactmetrics-funnel-modal__select-wrapper" };
const _hoisted_40 = ["onUpdate:modelValue"];
const _hoisted_41 = ["value"];
const _hoisted_42 = { class: "exactmetrics-funnel-modal__step-value-wrapper" };
const _hoisted_43 = ["onUpdate:modelValue", "placeholder"];
const _hoisted_44 = ["onClick"];
const _hoisted_45 = { class: "exactmetrics-funnel-modal__edit-actions" };
...
const _sfc_main$3 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emit = __emit;
    const texts = {
      pagePathPlaceholder: __$1("Enter page path", "google-analytics-dashboard-for-wp"),
      eventNamePlaceholder: __$1("Enter event name", "google-analytics-dashboard-for-wp")
    };
    ...
    const stepTypeOptions = [
      { value: "page", label: __$1("Page", "google-analytics-dashboard-for-wp") },
      { value: "event", label: __$1("Event", "google-analytics-dashboard-for-wp") }
    ];
    ...
    const createFunnel = () => {
      ...
      const ajaxData = {
        action: "exactmetrics_overview_report_save_funnel_filter",
      ...
      wp.ajax.post(ajaxData).done((response) => {
        if (response && response.id) {
          ...
          showSuccessToast({
            message: sprintf(
              ...
              __$1('Funnel "%s" has been created successfully.', "google-analytics-dashboard-for-wp"),
              response.name
            )
          });
        }
        ...
        showErrorToast({
          message: __$1("Failed to create funnel. Please try again.", "google-analytics-dashboard-for-wp")
        });
      }).always(() => {
        isSaving.value = false;
      });
    ...
    const saveEditFunnel = (funnelId) => {
      ...
      const ajaxData = {
        action: "exactmetrics_overview_report_update_funnel_filter",
        nonce: getMiGlobal$1("nonce", ""),
        funnel_id: funnelId,
      ...
      wp.ajax.post(ajaxData).done(() => {
        ...
        showSuccessToast({
          message: sprintf(
            /* translators: %s - funnel name */
            __$1('Funnel "%s" has been updated successfully.', "google-analytics-dashboard-for-wp"),
            updatedFunnel.name
          )
        });
      }).fail(() => {
        showErrorToast({
          message: __$1("Failed to update funnel. Please try again.", "google-analytics-dashboard-for-wp")
        });
      }).always(() => {
        isSaving.value = false;
      });
    ...
    const deleteFunnel = (funnelId) => {
      const ajaxData = {
        action: "exactmetrics_overview_report_delete_funnel_filter",
        nonce: getMiGlobal$1("nonce", ""),
        funnel_id: funnelId
      };
      wp.ajax.post(ajaxData).done(() => {
        ...
        showSuccessToast({
          message: __$1("Funnel deleted successfully.", "google-analytics-dashboard-for-wp")
        });
      }).fail(() => {
        showErrorToast({
          message: __$1("Failed to delete funnel. Please try again.", "google-analytics-dashboard-for-wp")
        });
      });
    };
    const clearForm = () => {
    ...
    const fetchSavedFunnels = () => {
      const ajaxData = {
        action: "exactmetrics_overview_report_get_funnel_filters",
        nonce: getMiGlobal$1("nonce", "")
      };
      wp.ajax.post(ajaxData).done((response) => {
      ...
      return __props.isOpen ? (openBlock(), createElementBlock("div", {
        ...
        createBaseVNode("div", {
          ...
          toast.value.visible ? (openBlock(), createElementBlock("div", {
            key: 0,
            class: normalizeClass(["exactmetrics-funnel-modal__toast", { "exactmetrics-funnel-modal__toast--error": toast.value.type === "error" }])
          }, [
            createVNode(Icon, {
          ...
          createBaseVNode("button", {
            type: "button",
            class: "exactmetrics-funnel-modal__close",
            "aria-label": unref(__$1)("Close funnel panel", "google-analytics-dashboard-for-wp"),
            onClick: closeModal
          }, [
            createVNode(Icon, {
              name: "close",
          ...
          createBaseVNode("div", _hoisted_2$2, [
            createBaseVNode("h2", _hoisted_3$2, toDisplayString(unref(__$1)("Manage Funnels", "google-analytics-dashboard-for-wp")), 1),
            createBaseVNode("button", {
              type: "button",
              class: "exactmetrics-funnel-modal__clear-all",
              onClick: clearForm
            }, toDisplayString(unref(__$1)("Clear All", "google-analytics-dashboard-for-wp")), 1)
          ]),
          createBaseVNode("div", _hoisted_4$1, [
            createBaseVNode("div", _hoisted_5$1, [
              createBaseVNode("h3", _hoisted_6$1, toDisplayString(unref(__$1)("Create New Funnel", "google-analytics-dashboard-for-wp")), 1),
              createBaseVNode("div", _hoisted_7$1, [
                createBaseVNode("label", _hoisted_8$1, toDisplayString(unref(__$1)("Funnel Name", "google-analytics-dashboard-for-wp")), 1),
                withDirectives(createBaseVNode("input", {
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => newFunnelName.value = $event),
                  type: "text",
                  class: "exactmetrics-funnel-modal__name-input",
                  placeholder: unref(__$1)("e.g. Checkout Funnel", "google-analytics-dashboard-for-wp")
                }, null, 8, _hoisted_9$1), [
            ...
            createBaseVNode("div", _hoisted_10$1, [
                  ...
                  return openBlock(), createElementBlock("div", {
                    ...
                    createBaseVNode("div", _hoisted_17$1, [
                      withDirectives(createBaseVNode("input", {
                        ...
                        type: "text",
                        class: "exactmetrics-funnel-modal__step-input",
                    ...
                    createBaseVNode("button", {
                      type: "button",
                      class: "exactmetrics-funnel-modal__step-delete",
              ...
              createBaseVNode("div", _hoisted_20$1, [
                createBaseVNode("button", {
                  type: "button",
                  class: "exactmetrics-funnel-modal__add-step-btn",
                  onClick: addNewStep
                }, [
                  createVNode(Icon, {
                    name: "plus",
                  ...
                  createBaseVNode("span", null, toDisplayString(unref(__$1)("Add Step", "google-analytics-dashboard-for-wp")), 1)
                ]),
                createBaseVNode("button", {
                  type: "button",
                  class: "exactmetrics-funnel-modal__create-btn",
                  disabled: isSaving.value,
                  onClick: createFunnel
                }, toDisplayString(isSaving.value ? unref(__$1)("Creating...", "google-analytics-dashboard-for-wp") : unref(__$1)("Create Funnel", "google-analytics-dashboard-for-wp")), 9, _hoisted_21$1)
              ])
            ])
          ]),
          _cache[2] || (_cache[2] = createBaseVNode("div", { class: "exactmetrics-funnel-modal__divider" }, null, -1)),
          createBaseVNode("div", _hoisted_22$1, [
            createBaseVNode("h3", _hoisted_23, toDisplayString(unref(__$1)("Your Saved Funnels", "google-analytics-dashboard-for-wp")), 1),
            unref(overviewStore).funnels.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_24, [
              createVNode(Icon, {
                name: "no-saved-filters",
                size: 64
              }),
              createBaseVNode("p", null, toDisplayString(unref(__$1)("No funnels found", "google-analytics-dashboard-for-wp")), 1)
              ...
              (openBlock(true), createElementBlock(Fragment, null, renderList(unref(overviewStore).funnels, (savedFunnel) => {
                return openBlock(), createElementBlock("div", {
                  key: savedFunnel.id,
                  class: normalizeClass(["exactmetrics-funnel-modal__saved-item", {
                    "exactmetrics-funnel-modal__saved-item--applied": savedFunnel.id === unref(overviewStore).activeFunnelId,
                    "exactmetrics-funnel-modal__saved-item--editing": editingFunnelId.value === savedFunnel.id
                  }]),
                  ...
                  createBaseVNode("div", _hoisted_27, [
                    createBaseVNode("div", _hoisted_28, [
                      ...
                      createBaseVNode("span", _hoisted_30, toDisplayString(unref(sprintf)(
                        ...
                        unref(__$1)("%d Steps", "google-analytics-dashboard-for-wp"),
                        savedFunnel.steps ? savedFunnel.steps.length : 0
                      )), 1),
                      savedFunnel.id === unref(overviewStore).activeFunnelId ? (openBlock(), createElementBlock("span", _hoisted_31, toDisplayString(unref(__$1)("Applied", "google-analytics-dashboard-for-wp")), 1)) : hoveredFunnelId.value === savedFunnel.id && editingFunnelId.value !== savedFunnel.id ? (openBlock(), createElementBlock("span", {
                        key: 1,
                        class: "exactmetrics-funnel-modal__saved-item-status exactmetrics-funnel-modal__saved-item-status--apply",
                        onClick: ($event) => applySavedFunnel(savedFunnel)
                      }, toDisplayString(unref(__$1)("Apply", "google-analytics-dashboard-for-wp")), 9, _hoisted_32)) : createCommentVNode("", true)
                    ]),
                    createBaseVNode("div", _hoisted_33, [
                      isDefaultFunnel(savedFunnel.id) ? (openBlock(), createElementBlock("span", _hoisted_34, toDisplayString(unref(__$1)("Default", "google-analytics-dashboard-for-wp")), 1)) : createCommentVNode("", true),
                      !isDefaultFunnel(savedFunnel.id) ? (openBlock(), createElementBlock(Fragment, { key: 1 }, [
                        createBaseVNode("button", {
                          type: "button",
                          class: "exactmetrics-funnel-modal__saved-item-btn",
                  ...
                  editingFunnelId.value === savedFunnel.id ? (openBlock(), createElementBlock("div", _hoisted_37, [
                    ...
                    createBaseVNode("div", _hoisted_45, [
                      createBaseVNode("button", {
                        type: "button",
                        class: "exactmetrics-funnel-modal__add-step-btn exactmetrics-funnel-modal__add-step-btn--sm",
                        onClick: addEditStep
                      }, [
                        createVNode(Icon, {
                          name: "plus",
                      ...
                      createBaseVNode("button", {
                        type: "button",
                        class: "exactmetrics-funnel-modal__save-edit-btn",
                        disabled: isSaving.value,
                        onClick: ($event) => saveEditFunnel(savedFunnel.id)
                      }, toDisplayString(isSaving.value ? unref(__$1)("Saving...", "google-analytics-dashboard-for-wp") : unref(__$1)("Save", "google-analytics-dashboard-for-wp")), 9, _hoisted_46)
                    ])
                  ])) : createCommentVNode("", true)
                ], 42, _hoisted_26);
              }), 128))
...
const _hoisted_1$1 = { class: "exactmetrics-overview-ecommerce-funnel" };
const _hoisted_2$1 = { class: "exactmetrics-overview-ecommerce-funnel__header" };
const _hoisted_3$1 = { class: "exactmetrics-overview-ecommerce-funnel__header-left" };
const _hoisted_4 = { class: "exactmetrics-overview-ecommerce-funnel__title" };
const _hoisted_5 = { class: "exactmetrics-overview-ecommerce-funnel__funnel-select-wrapper" };
const _hoisted_6 = ["disabled"];
const _hoisted_7 = { value: "" };
const _hoisted_8 = ["value"];
const _hoisted_9 = { class: "exactmetrics-overview-ecommerce-funnel__header-right" };
const _hoisted_10 = {
  href: "/wp-admin/admin.php?page=exactmetrics_reports#/ecommerce-funnel",
  class: "exactmetrics-overview-ecommerce-funnel__view-link"
};
const _hoisted_11 = {
  key: 0,
  class: "exactmetrics-overview-ecommerce-funnel__loading"
};
const _hoisted_12 = {
  key: 1,
  class: "exactmetrics-overview-ecommerce-funnel__error"
};
const _hoisted_13 = {
  key: 2,
  class: "exactmetrics-overview-ecommerce-funnel__table-wrapper"
};
const _hoisted_14 = { class: "exactmetrics-overview-ecommerce-funnel__table" };
const _hoisted_15 = { class: "exactmetrics-overview-ecommerce-funnel__th-content" };
const _hoisted_16 = { class: "exactmetrics-overview-ecommerce-funnel__th-content" };
const _hoisted_17 = { class: "exactmetrics-overview-ecommerce-funnel__th-content" };
const _hoisted_18 = { class: "exactmetrics-overview-ecommerce-funnel__th-content" };
const _hoisted_19 = { class: "exactmetrics-overview-ecommerce-funnel__th-content" };
const _hoisted_20 = { class: "exactmetrics-overview-ecommerce-funnel__th-content" };
const _hoisted_21 = {
  key: 3,
  class: "exactmetrics-overview-ecommerce-funnel__empty"
};
const _hoisted_22 = {
  key: 4,
  class: "exactmetrics-overview-ecommerce-funnel__empty"
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          createBaseVNode("div", _hoisted_3$1, [
            createBaseVNode("h2", _hoisted_4, toDisplayString(unref(__$1)("Funnels", "google-analytics-dashboard-for-wp")), 1),
            createBaseVNode("div", _hoisted_5, [
              withDirectives(createBaseVNode("select", {
                "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => selectedFunnelId.value = $event),
                class: "exactmetrics-overview-ecommerce-funnel__funnel-select",
                disabled: funnelLoading.value,
                onChange: onFunnelChange
              }, [
                createBaseVNode("option", _hoisted_7, toDisplayString(unref(__$1)("Choose Funnel", "google-analytics-dashboard-for-wp")), 1),
          ...
          createBaseVNode("div", _hoisted_9, [
            createBaseVNode("button", {
              type: "button",
              class: "exactmetrics-overview-ecommerce-funnel__manage-btn",
              onClick: openFunnelModal
            }, [
              createBaseVNode("span", null, toDisplayString(unref(__$1)("Manage Funnels", "google-analytics-dashboard-for-wp")), 1),
              createVNode(Icon, {
                name: "settings",
                size: 16
              })
        ...
        activeFunnel.value && funnelLoading.value ? (openBlock(), createElementBlock("div", _hoisted_11, [
          createBaseVNode("span", null, toDisplayString(unref(__$1)("Loading funnel data...", "google-analytics-dashboard-for-wp")), 1)
              ...
              createBaseVNode("tr", null, [
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_15, [
                    createBaseVNode("span", null, toDisplayString(unref(sprintf)(
                      /* translators: %s - funnel name */
                      unref(__$1)("%s - Steps", "google-analytics-dashboard-for-wp"),
                ...
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_16, [
                    createBaseVNode("span", null, toDisplayString(unref(__$1)("Active Users (% of Step 1)", "google-analytics-dashboard-for-wp")), 1),
                    createVNode(Icon, {
                      name: "sort",
                      size: 12
                    })
                ...
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_17, [
                    createBaseVNode("span", null, toDisplayString(unref(__$1)("Completion Rates", "google-analytics-dashboard-for-wp")), 1),
                    createVNode(Icon, {
                      name: "sort",
                      size: 12
                    })
                ...
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_18, [
                    createBaseVNode("span", null, toDisplayString(unref(__$1)("Abandonments", "google-analytics-dashboard-for-wp")), 1),
                    createVNode(Icon, {
                      name: "sort",
                      size: 12
                    })
                ...
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_19, [
                    createBaseVNode("span", null, toDisplayString(unref(__$1)("Abandonment Rate", "google-analytics-dashboard-for-wp")), 1),
                    createVNode(Icon, {
                      name: "sort",
                      size: 12
                    })
                ...
                createBaseVNode("th", null, [
                  createBaseVNode("div", _hoisted_20, [
                    createBaseVNode("span", null, toDisplayString(unref(__$1)("Overall Conversion Rate", "google-analytics-dashboard-for-wp")), 1),
                    createVNode(Icon, {
                      name: "sort",
                      size: 12
                    })
            ...
            createBaseVNode("tfoot", null, [
              createBaseVNode("tr", null, [
                createBaseVNode("td", null, toDisplayString(unref(sprintf)(
                  /* translators: %s - funnel name */
                  unref(__$1)("%s Conversion Rate", "google-analytics-dashboard-for-wp"),
                  activeFunnel.value.name
                )), 1),
          ...
          createBaseVNode("p", null, toDisplayString(unref(__$1)("No funnel data for this period", "google-analytics-dashboard-for-wp")), 1)
        ])) : (openBlock(), createElementBlock("div", _hoisted_22, [
          createVNode(Icon, {
            name: "no-saved-filters",
            size: 64
          }),
          createBaseVNode("p", null, toDisplayString(unref(__$1)("Select a funnel to view data", "google-analytics-dashboard-for-wp")), 1)
        ])),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const text = {
      formSubmissions: __$1("Form Submissions", "google-analytics-dashboard-for-wp"),
      eCommerceLog: __$1("eCommerce Log", "google-analytics-dashboard-for-wp"),
      eCommerceData: __$1("eCommerce Data", "google-analytics-dashboard-for-wp")
    };
    const viewFullReportUrls = {
      formSubmissions: "/wp-admin/admin.php?page=exactmetrics_reports#/forms",
      ecommerce: "/wp-admin/admin.php?page=exactmetrics_reports#/ecommerce"
    };
    ...
    const formSubmissionsTabs = [
      { label: __$1("Source / Medium", "google-analytics-dashboard-for-wp"), value: "sourceMedium" },
      { label: __$1("Campaign", "google-analytics-dashboard-for-wp"), value: "campaign" }
    ];
    const formSubmissionsActiveTab = ref("sourceMedium");
    const formSubmissionsColumnsByTab = {
      sourceMedium: [
        { key: "formSubmitDate", label: __$1("Form Submit Date", "google-analytics-dashboard-for-wp") },
        { key: "formId", label: __$1("Form ID", "google-analytics-dashboard-for-wp") },
        { key: "country", label: __$1("Country", "google-analytics-dashboard-for-wp") },
        { key: "source", label: __$1("Source", "google-analytics-dashboard-for-wp") },
        { key: "medium", label: __$1("Medium", "google-analytics-dashboard-for-wp") }
      ],
      campaign: [
        { key: "campaign", label: __$1("Campaign", "google-analytics-dashboard-for-wp") },
        { key: "formId", label: __$1("Form ID", "google-analytics-dashboard-for-wp") },
        { key: "country", label: __$1("Country", "google-analytics-dashboard-for-wp") },
        { key: "source", label: __$1("Source", "google-analytics-dashboard-for-wp") },
        { key: "medium", label: __$1("Medium", "google-analytics-dashboard-for-wp") }
    ...
    const eCommerceLogTabs = [
      { label: __$1("Date", "google-analytics-dashboard-for-wp"), value: "date" },
      { label: __$1("Source / Medium", "google-analytics-dashboard-for-wp"), value: "sourceMedium" },
      { label: __$1("Campaign", "google-analytics-dashboard-for-wp"), value: "campaign" }
    ];
    const eCommerceLogActiveTab = ref("date");
    const eCommerceLogColumnDefs = [
      { key: "transactionDate", label: __$1("Transaction Date", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "transactionId", label: __$1("Transaction ID", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "transactionSource", label: __$1("Transaction Source", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "transactionMedium", label: __$1("Transaction medium", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "transactionCampaign", label: __$1("Transaction Campaign", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "revenue", label: __$1("Revenue", "google-analytics-dashboard-for-wp") }
    ];
    ...
    const eCommerceDataTabs = [
      { label: __$1("Coupon", "google-analytics-dashboard-for-wp"), value: "coupon" }
    ];
    const eCommerceDataActiveTab = ref("coupon");
    const eCommerceDataColumns = [
      { key: "productName", label: __$1("Product Name", "google-analytics-dashboard-for-wp") },
      { key: "coupon", label: __$1("Coupon", "google-analytics-dashboard-for-wp"), excludeFromTotals: true },
      { key: "revenue", label: __$1("Revenue", "google-analytics-dashboard-for-wp") },
      { key: "orders", label: __$1("Orders", "google-analytics-dashboard-for-wp") },
      { key: "percentOfSales", label: __$1("% of Sales", "google-analytics-dashboard-for-wp") }
    ];
...
const _hoisted_3 = { class: "exactmetrics-overview-report-two-col" };
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const text = {
      marketingCampaigns: __$1("Marketing Campaigns", "google-analytics-dashboard-for-wp"),
      pages: __$1("Pages", "google-analytics-dashboard-for-wp"),
      demographics: __$1("Demographics", "google-analytics-dashboard-for-wp"),
      devices: __$1("Devices", "google-analytics-dashboard-for-wp")
    };
    const viewFullReportUrls = {
      marketingCampaigns: "/wp-admin/admin.php?page=exactmetrics_reports#/traffic-campaign",
      pages: "/wp-admin/admin.php?page=exactmetrics_reports#/traffic-landing-pages",
      devices: "/wp-admin/admin.php?page=exactmetrics_reports#/traffic-technology"
    };
    const keyMetricsFullReportUrls = {
      traffic: "/wp-admin/admin.php?page=exactmetrics_reports#/traffic-overview",
      engagement: "/wp-admin/admin.php?page=exactmetrics_reports#/publishers",
      referrals: "/wp-admin/admin.php?page=exactmetrics_reports#/traffic-source-medium",
      ecommerce: "/wp-admin/admin.php?page=exactmetrics_reports#/ecommerce"
    };
    ...
    function parseMarketingCampaignsRows(apiData) {
      ...
      return rows.map((row) => {
        const dimVal = row?.d?.[0];
        const name = dimVal !== void 0 && dimVal !== null && String(dimVal).trim() !== "" ? String(dimVal) : __$1("(not set)", "google-analytics-dashboard-for-wp");
        const m0 = row?.m?.[0];
        const arr = Array.isArray(m0) ? m0 : [];
        const sessions = parseFloat(arr[0]) || 0;
        const users = parseFloat(arr[1]) || 0;
    ...
    const marketingCampaignsTabs = [
      { label: __$1("Campaign", "google-analytics-dashboard-for-wp"), value: "campaign" },
      { label: __$1("Source", "google-analytics-dashboard-for-wp"), value: "source" },
      { label: __$1("Medium", "google-analytics-dashboard-for-wp"), value: "medium" },
      { label: __$1("Term", "google-analytics-dashboard-for-wp"), value: "term" },
      { label: __$1("Content", "google-analytics-dashboard-for-wp"), value: "content" }
    ];
    const marketingCampaignsActiveTab = ref("campaign");
    const marketingCampaignsColumnLabels = {
      campaign: __$1("Campaign Name", "google-analytics-dashboard-for-wp"),
      source: __$1("Source", "google-analytics-dashboard-for-wp"),
      medium: __$1("Medium", "google-analytics-dashboard-for-wp"),
      term: __$1("Term", "google-analytics-dashboard-for-wp"),
      content: __$1("Content", "google-analytics-dashboard-for-wp")
    };
    ...
    const marketingCampaignsColumnsBase = [
      ...
      { key: "users", label: __$1("Users", "google-analytics-dashboard-for-wp"), sortable: true },
      { key: "engagement", label: __$1("Engagement", "google-analytics-dashboard-for-wp"), sortable: true },
      ...
      { key: "averageOrderValue", label: __$1("Average Order Value", "google-analytics-dashboard-for-wp"), sortable: true },
    ...
    const pagesTabs = [
      { label: __$1("Landing Page", "google-analytics-dashboard-for-wp"), value: "landingPage" },
      { label: __$1("Page Location", "google-analytics-dashboard-for-wp"), value: "pageLocation" },
      { label: __$1("Page Title", "google-analytics-dashboard-for-wp"), value: "pageTitle" },
      { label: __$1("Query String", "google-analytics-dashboard-for-wp"), value: "queryString" }
    ];
    const pagesActiveTab = ref("landingPage");
    const pagesColumnLabels = {
      landingPage: __$1("Landing Page", "google-analytics-dashboard-for-wp"),
      pageLocation: __$1("Page Location", "google-analytics-dashboard-for-wp"),
      pageTitle: __$1("Page Title", "google-analytics-dashboard-for-wp"),
      queryString: __$1("Query String", "google-analytics-dashboard-for-wp")
    };
    ...
    const demographicsTabs = [
      { label: __$1("Country", "google-analytics-dashboard-for-wp"), value: "country" },
      { label: __$1("State", "google-analytics-dashboard-for-wp"), value: "state" },
      { label: __$1("New vs Returning", "google-analytics-dashboard-for-wp"), value: "newVsReturning" }
    ];
    const demographicsActiveTab = ref("country");
    const demographicsColumnLabels = {
      country: __$1("Country", "google-analytics-dashboard-for-wp"),
      state: __$1("State", "google-analytics-dashboard-for-wp"),
      newVsReturning: __$1("New vs Returning", "google-analytics-dashboard-for-wp")
    };
    ...
    const devicesTabs = [
      { label: __$1("Browser", "google-analytics-dashboard-for-wp"), value: "browser" },
      { label: __$1("OS", "google-analytics-dashboard-for-wp"), value: "os" },
      { label: __$1("Size", "google-analytics-dashboard-for-wp"), value: "size" }
    ];
    const devicesActiveTab = ref("browser");
    const devicesColumnLabels = {
      browser: __$1("Browser", "google-analytics-dashboard-for-wp"),
      os: __$1("OS", "google-analytics-dashboard-for-wp"),
      size: __$1("Size", "google-analytics-dashboard-for-wp")
    };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["exactmetrics-overview-report", { "exactmetrics-blur": shouldBlur.value }])
      }, [
        !canViewReports.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
          createBaseVNode("h3", null, toDisplayString(unref(__$1)("You don't have permission to view ExactMetrics reports.", "google-analytics-dashboard-for-wp")), 1),
          createBaseVNode("div", _hoisted_2, [
            createBaseVNode("p", null, toDisplayString(unref(__$1)("Please check with your site administrator that your role is included in the ExactMetrics permissions settings.", "google-analytics-dashboard-for-wp")), 1)
          ])
        ])) : createCommentVNode("", true),
