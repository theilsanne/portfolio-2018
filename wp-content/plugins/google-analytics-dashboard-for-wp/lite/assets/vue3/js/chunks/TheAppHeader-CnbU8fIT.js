...
const getMiGlobal$1 = (key, defaultValue = null) => {
  return typeof window !== "undefined" && window.exactmetrics && typeof window.exactmetrics === "object" && Object.hasOwn(window.exactmetrics, key) ? window.exactmetrics[key] : defaultValue;
};
async function ensureBearerToken(minValidityMs = 5 * 60 * 1e3) {
  ...
  try {
    const response = await window.wp.ajax.post("exactmetrics_get_bearer_token", {
      nonce
    });
    ...
    if (token && typeof token === "string") {
      if (window.exactmetrics && typeof window.exactmetrics === "object") {
        window.exactmetrics.bearer_token = token;
        window.exactmetrics.bearer_expires = expiresAt ?? 0;
      }
      return true;
    }
  } catch (e) {
...
const getAddonsPageUrl = () => {
  return getMiGlobal$1("addons_page_url", "/wp-admin/admin.php?page=exactmetrics_settings#/addons");
};
const isAuthed = () => {
...
function getUrl$1(medium, campaign, url) {
  ...
  url = url ? url : `https://www.exactmetrics.com/${default_url}`;
...
const getExactMetricsUrl = (type, id, fallbackUrl) => {
  if (typeof window !== "undefined" && window.exactmetrics) {
    if (typeof window.exactmetrics.getUrl === "function") {
      try {
        const url = window.exactmetrics.getUrl(type, id, fallbackUrl);
        if (url) {
          return url;
        }
      } catch (_e) {
    ...
    if (window.exactmetrics.utils && typeof window.exactmetrics.utils.getUrl === "function") {
      try {
        const url = window.exactmetrics.utils.getUrl(type, id, fallbackUrl);
        if (url) {
          return url;
        }
      } catch (_e) {
...
const logoStandard = "" + new URL("../../assets/logo-exactmetrics-g7cO_2BB.png", import.meta.url).href;
const logoStandard2x = "" + new URL("../../assets/logo-exactmetrics@2x-D852PtD5.png", import.meta.url).href;
...
const _sfc_main$4 = {
  ...
  setup(__props) {
    ...
    const link = computed(() => {
      ...
      return getUrl$1("logo", "header", "https://www.exactmetrics.com/lite/");
    });
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        class: normalizeClass(["exactmetrics-logo-area", isPremium.value ? "exactmetrics-logo-area-premium" : ""])
      }, [
        createBaseVNode("a", {
          href: link.value,
...
const fetchNotifications = () => new Promise((resolve2, reject) => {
  const action = "exactmetrics_vue_get_notifications";
  const ajaxData = {
  ...
  wp.ajax.post(action, ajaxData).done((response) => {
    ...
    let message = errorThrown || __("An error occurred while fetching notifications.", "exactmetrics");
    ...
    reject({
      title: __("Fetch Notifications Network Error", "exactmetrics"),
      message
    });
  });
});
const dismissNotification = (id) => new Promise((resolve2, reject) => {
  const action = "exactmetrics_notification_dismiss";
  const ajaxData = {
    nonce: getMiGlobal("nonce", ""),
    // Use centralized helper
    id
  ...
  wp.ajax.post(action, ajaxData).done((response) => {
    ...
    reject({
      title: __("Dismiss Notification Network Error", "exactmetrics"),
      message
    });
  });
});
...
const _hoisted_1$3 = { class: "exactmetrics-notificationsv3-single-notification" };
const _hoisted_2$3 = ["innerHTML"];
const _hoisted_3$3 = { class: "exactmetrics-notificationsv3-notification-details" };
const _hoisted_4$2 = { class: "exactmetrics-notificationsv3-notification-title" };
const _hoisted_5$1 = ["innerHTML"];
const _hoisted_6$1 = { class: "exactmetrics-notificationsv3-notification-content" };
const _hoisted_7$1 = ["innerHTML"];
const _hoisted_8$1 = { class: "exactmetrics-notificationsv3-notification-actions" };
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    const text_dismiss = __2("Dismiss", "google-analytics-dashboard-for-wp");
    const text_install_activated = __2("Installed & Active", "google-analytics-dashboard-for-wp");
    ...
    const buttonClass = (type) => {
      return "exactmetrics-button exactmetrics-button-" + type;
    };
    const dismiss = (notificationId) => {
      notificationsStore.dismissNotificationAction(notificationId).then(() => {
        const menu_indicator = document.querySelector(".exactmetrics-menu-notification-indicator");
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("div", {
          class: "exactmetrics-notificationsv3-notification-icon",
          ...
          createBaseVNode("div", _hoisted_8$1, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.notification.btns, (button, button_type) => {
              return openBlock(), createElementBlock("a", {
                ...
                class: normalizeClass(["exactmetrics-button", buttonClass(button_type)]),
...
const _hoisted_1$2 = { class: "exactmetrics-notificationsv3-container" };
const _hoisted_2$2 = { class: "exactmetrics-notificationsv3-sidebar-header-top" };
const _hoisted_3$2 = { class: "exactmetrics-notificationsv3-sidebar-header-top-title" };
const _hoisted_4$1 = ["textContent"];
const _hoisted_5 = ["textContent"];
const _hoisted_6 = { class: "exactmetrics-notificationsv3-sidebar-header-top-actions" };
const _hoisted_7 = ["textContent"];
const _hoisted_8 = ["textContent"];
const _hoisted_9 = { class: "exactmetrics-notificationsv3-sidebar-header-bottom" };
const _hoisted_10 = { class: "exactmetrics-notificationsv3-sidebar-header-bottom-notifications-count" };
const _hoisted_11 = ["textContent"];
const _hoisted_12 = ["textContent"];
const _hoisted_13 = ["textContent"];
const _hoisted_14 = {
  key: 0,
  class: "exactmetrics-notificationsv3-sidebar-header-bottom-actions"
};
const _hoisted_15 = ["textContent"];
const _hoisted_16 = {
  key: 0,
  class: "exactmetrics-notificationsv3-sidebar-notifications exactmetrics-notificationsv3-notifications-active"
};
const _hoisted_17 = {
  key: 0,
  class: "exactmetrics-notificationsv3-no-notifications"
};
const _hoisted_18 = ["textContent"];
const _hoisted_19 = {
  key: 1,
  class: "exactmetrics-notificationsv3-sidebar-notifications exactmetrics-notificationsv3-notifications-dismissed"
};
const _hoisted_20 = {
  key: 0,
  class: "exactmetrics-notificationsv3-no-notifications"
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    const text_inbox = __2("Inbox", "google-analytics-dashboard-for-wp");
    const text_back_to_inbox = __2("Back to Inbox", "google-analytics-dashboard-for-wp");
    const text_view_dismissed = __2("View Dismissed", "google-analytics-dashboard-for-wp");
    const text_notifications = __2("Notifications", "google-analytics-dashboard-for-wp");
    const text_dismiss_all = __2("Dismiss All", "google-analytics-dashboard-for-wp");
    const text_dismissed = __2("Dismissed", "google-analytics-dashboard-for-wp");
    const text_no_notifications = __2("No Notifications", "google-analytics-dashboard-for-wp");
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$2, [
        __props.isOpen ? (openBlock(), createElementBlock("div", {
          ...
          class: normalizeClass([
            ...
            __props.isOpen ? "exactmetrics-notificationsv3-sidebar-in" : "exactmetrics-notificationsv3-sidebar-out"
          ])
        }, [
          createBaseVNode("div", _hoisted_2$2, [
            ...
            createBaseVNode("div", _hoisted_6, [
              ...
              createBaseVNode("button", {
                class: "exactmetrics-button exactmetrics-notificationsv3-sidebar-close",
...
const _hoisted_2$1 = { class: "exactmetrics-notificationsv3-inbox-button" };
  ...
  setup(__props) {
    ...
    onMounted(async () => {
      ...
      if (typeof queryString !== "undefined") {
        ...
        if (typeof open !== "undefined" && open === "exactmetrics_notification_sidebar") {
          isOpen.value = true;
        }
      }
    });
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("div", _hoisted_2$1, [
          ...
          createBaseVNode("span", {
            class: normalizeClass([
              "exactmetrics-notificationsv3-inbox-number",
...
const _hoisted_1 = { class: "exactmetrics-header" };
const _hoisted_2 = { class: "exactmetrics-container exactmetrics-header-container" };
const _hoisted_3 = { class: "exactmetrics-header-left" };
const _hoisted_4 = { class: "exactmetrics-header-right exactmetrics-float-right" };
const _sfc_main = {
  __name: "TheAppHeader",
  setup(__props) {
    return (_ctx, _cache) => {
